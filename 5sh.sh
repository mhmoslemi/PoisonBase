#!/usr/bin/env bash
#
# RESUME  CIFAR10_ResNet20BN_gradmatch_random_dog-bird_b0.02_eps8_seed42_ce5_tgt14
#
...
#   * results.csv is read first, so the 36 (target, victim) trials already
#     done are skipped and new rows appended.
#   * deltas.pt is reloaded, so the 6 finished crafts are reused.
#
# Targets (10): [5118, 8740, 5324, 4630, 833, 2065, 7056, 9059, 6707, 9874]
#   done   -> 5118 8740 5324 4630 833 2065  (6/10, 6 victims each)
#   to run -> 7056 9059 6707 9874  (24 trainings)
...
RUN=CIFAR10_ResNet20BN_gradmatch_random_dog-bird_b0.02_eps8_seed42_ce5_tgt14
