#!/usr/bin/env bash
#
# tab:augmentation-robustness -- RandAugment + Crop+Flip -- frog-airplane / GM / $2e-2$
#
# Cells filled by this script (ResNet20BN, Random and DPP side by side):
#
#     frog-airplane & GM & $2e-2$ & Random & <Crop+Flip> <RandAugment>
#     frog-airplane & GM & $2e-2$ & DPP    & <Crop+Flip> <RandAugment>
#
...
#
#   sh aug06.sh              # as configured
#   DRY_RUN=1 sh aug06.sh    # print the defense.py commands and stop
