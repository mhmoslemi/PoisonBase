...
RUN_TOPK_SIDE_BY_SIDE = False  # left: linear-x overlap; right: log-x overlap
...
RANK_Y_LABEL_FONT_SIZE = 25
RANK_X_LABEL_FONT_SIZE = 25
RANK_Y_LABEL_X =-0.28
RANK_Y_LABEL_Y = 0.5
...
# Identity reference for the rank-rank scatter plots.
RANK_SHOW_IDENTITY_LINE = True
RANK_IDENTITY_LINE_COLOR = "#222222"
RANK_IDENTITY_LINE_STYLE = "--"
RANK_IDENTITY_LINE_WIDTH = 1.0
RANK_IDENTITY_LINE_ALPHA = 1.0
...
def plot_rank_grid(experiment):
    ...
    for output_target, target in rank_targets:
        ...
        if RANK_SHOW_IDENTITY_LINE:
            ax.plot(
                (0.0, 1.0),
                (0.0, 1.0),
                color=RANK_IDENTITY_LINE_COLOR,
                linestyle=RANK_IDENTITY_LINE_STYLE,
                linewidth=RANK_IDENTITY_LINE_WIDTH,
                alpha=RANK_IDENTITY_LINE_ALPHA,
                zorder=4,
            )
