#!/usr/bin/env bash
#
# tab:augmentation-robustness -- RandAugment + Crop+Flip -- frog-airplane / GM / $2e-3$
#
# Cells filled by this script (ResNet20BN, Random and DPP side by side):
#
#     frog-airplane & GM & $2e-3$ & Random & <Crop+Flip> <RandAugment>
#     frog-airplane & GM & $2e-3$ & DPP    & <Crop+Flip> <RandAugment>
#
...
#
#   sh aug05.sh              # as configured
#   DRY_RUN=1 sh aug05.sh    # print the defense.py commands and stop
