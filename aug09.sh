#!/usr/bin/env bash
#
# tab:augmentation-robustness -- Cutout -- dog-bird GM (both budgets) + dog-bird FC 2e-3
#
# Cells filled by this script (ResNet20BN, Random and DPP side by side):
#
#     dog--bird & GM & $2{\\times}10^{-3}$ and $2{\\times}10^{-2}$ & Random, DPP & <Cutout>
#     dog--bird & FC & $2{\\times}10^{-3}$                            & Random, DPP & <Cutout>
#
...
#
#   sh aug09.sh              # as configured
#   DRY_RUN=1 sh aug09.sh    # print the defense.py commands and stop
