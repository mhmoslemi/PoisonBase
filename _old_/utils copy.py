...
from _old_.networks import MLP, ConvNet, LeNet, AlexNet, AlexNetBN, VGG11, VGG11BN, VGG13, VGG13BN, VGG16, VGG19, ResNet18, ResNet18BN_AP, ResNet18BN, ResNet18_AP, ResNet20, ResNet20BN, ResNet34, ResNet50, ResNet101, ResNet152
...
def get_network(model, channel, num_classes, im_size=(32, 32)):
    ...
    if model == 'MLP':
        ...
        net = VGG19(channel=channel, num_classes=num_classes)
    elif model == 'ResNet20':
        net = ResNet20(channel=channel, num_classes=num_classes)
    elif model == 'ResNet20BN':
        ...
        net = ResNet152(channel=channel, num_classes=num_classes)
