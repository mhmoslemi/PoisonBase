#!/usr/bin/env bash
#
# tab:augmentation-robustness -- RandAugment + Crop+Flip -- dog-bird / GM / $2e-3$
#
# Cells filled by this script (ResNet20BN, Random and DPP side by side):
#
#     dog-bird & GM & $2e-3$ & Random & <Crop+Flip> <RandAugment>
#     dog-bird & GM & $2e-3$ & DPP    & <Crop+Flip> <RandAugment>
#
...
#
#   sh aug01.sh              # as configured
#   DRY_RUN=1 sh aug01.sh    # print the defense.py commands and stop
