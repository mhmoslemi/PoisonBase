#!/usr/bin/env bash
#
# ca4 -- ConvNetBN / FC / dog-bird / $1{\times}10^{-2}$ / DPP
#
# Fills these 3 cells of aug_table.tex (the ConvNetBN block):
#
#     dog--bird & FC & $1{\times}10^{-2}$ & DPP & (No Aug.) & <Crop+Flip> <RandAugment> <Cutout>
#
...
#
#   sh ca4.sh
#   DRY_RUN=1 sh ca4.sh    # print the defense.py commands and stop
...
if n < len(have['dpp']) or n < 5:
    sys.exit('ca4: the Random arm is not fully crafted for b0.01 (%d of %d paired). '
