#!/usr/bin/env bash
#
# tab:augmentation-robustness -- RandAugment + Crop+Flip -- dog-bird / FC / $1e-2$
#
# Cells filled by this script (ResNet20BN, Random and DPP side by side):
#
#     dog-bird & FC & $1e-2$ & Random & <Crop+Flip> <RandAugment>
#     dog-bird & FC & $1e-2$ & DPP    & <Crop+Flip> <RandAugment>
#
...
#
#   sh aug04.sh              # as configured
#   DRY_RUN=1 sh aug04.sh    # print the defense.py commands and stop
