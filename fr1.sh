#!/usr/bin/env bash
#
# tab:defense-robustness -- FRIENDS / GM / dog-bird b0.02 (DPP only)
#
...
#
#     dog--bird & GM & $2{\times}10^{-2}$ & .. & .. & .. & .. & (done) & <DPP>
#
...
#
#   sh fr1.sh
#   DRY_RUN=1 sh fr1.sh    # print the defense.py commands and stop
