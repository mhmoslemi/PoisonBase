#!/usr/bin/env bash
#
# tab:augmentation-robustness -- RandAugment + Crop+Flip -- dog-bird / FC / $2e-3$
#
# Cells filled by this script (ResNet20BN, Random and DPP side by side):
#
#     dog-bird & FC & $2e-3$ & Random & <Crop+Flip> <RandAugment>
#     dog-bird & FC & $2e-3$ & DPP    & <Crop+Flip> <RandAugment>
#
...
#
#   sh aug03.sh              # as configured
#   DRY_RUN=1 sh aug03.sh    # print the defense.py commands and stop
