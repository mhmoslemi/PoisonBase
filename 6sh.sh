...
#   * results.csv is read first, so the 17 (target, victim) trials already
#     done are skipped and new rows appended.
#   * deltas.pt is reloaded, so the 3 finished crafts are reused.
#
# Targets (10): [5118, 8740, 5324, 4630, 833, 2065, 7056, 9059, 6707, 9874]
#   done   -> 5118 8740  (2/10, 6 victims each)
#   partial-> 5324(5/6 victims)
#   to run -> 5324 4630 833 2065 7056 9059 6707 9874  (43 trainings)
#   crafts already cached for: 5324
#
