#!/usr/bin/env bash
#
# tab:augmentation-robustness -- RandAugment + Crop+Flip -- frog-airplane / FC / $1e-2$
#
# Cells filled by this script (ResNet20BN, Random and DPP side by side):
#
#     frog-airplane & FC & $1e-2$ & Random & <Crop+Flip> <RandAugment>
#     frog-airplane & FC & $1e-2$ & DPP    & <Crop+Flip> <RandAugment>
#
...
#
#   sh aug08.sh              # as configured
#   DRY_RUN=1 sh aug08.sh    # print the defense.py commands and stop
