#!/usr/bin/env bash
#
# tab:defense-robustness -- FRIENDS / GM / frog-airplane / $2{\times}10^{-2}$ / DPP only
#
# Shard 3 of 3, split out of the old fr2.sh (which was 4 runs / ~12.8 h in one
...
#
#   sh fr2c.sh
#   DRY_RUN=1 sh fr2c.sh    # print the defense.py command and stop
