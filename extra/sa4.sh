...
# budgets 0.001 0.01 for VGG13BN / dog-bird.
#
...
#
#   VGG13 dog-bird b0.001        10 crafts x   54 s + 60 trials x 100 s   ~1.82 h
#   VGG13 dog-bird b0.01         10 crafts x 1115 s + 60 trials x 100 s   ~4.76 h
#   ------------------------------------------------------------------
...
#
#     sh sa4.sh
#     BUDGETS="0.001" sh sa4.sh     # narrow it if the allocation is short
...
for pair in $PAIRS_; do
    echo "=== sa4 | sapa worst sigma=0.05 | $MODEL_ / random / $pair | budgets $BUDGETS_ ==="
