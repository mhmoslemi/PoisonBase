#!/usr/bin/env bash
#
# tab:defense-robustness -- FC / frog-airplane / $1{x}10^{-2}$ / FRIENDS
#
...
#
#     frog--airplane & FC & $1{\times}10^{-2}$ & .. & .. & .. & .. & <Random> & <DPP>
#
...
#
#   sh fcdef8.sh
#   DRY_RUN=1 sh fcdef8.sh    # print the defense.py commands and stop
