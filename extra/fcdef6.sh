#!/usr/bin/env bash
#
# tab:defense-robustness -- FC / frog-airplane / $2{x}10^{-3}$ / FRIENDS
#
...
#
#     frog--airplane & FC & $2{\times}10^{-3}$ & .. & .. & .. & .. & <Random> & <DPP>
#
...
#
#   sh fcdef6.sh
#   DRY_RUN=1 sh fcdef6.sh    # print the defense.py commands and stop
