...
# budgets 0.001 0.01 for ResNet20BN / dog-bird.
#
...
#
#   ResNet20 dog-bird b0.001     10 crafts x   58 s + 60 trials x 130 s   ~2.33 h
#   ResNet20 dog-bird b0.01      10 crafts x 1080 s + 60 trials x 130 s   ~5.17 h
#   ------------------------------------------------------------------
...
#
#     sh sa2.sh
#     BUDGETS="0.001" sh sa2.sh     # narrow it if the allocation is short
...
for pair in $PAIRS_; do
    echo "=== sa2 | sapa worst sigma=0.05 | $MODEL_ / random / $pair | budgets $BUDGETS_ ==="
