#!/usr/bin/env bash
#
# tab:defense-robustness -- FC / dog-bird / $1{x}10^{-2}$ / FRIENDS
#
...
#
#     dog--bird & FC & $1{\times}10^{-2}$ & .. & .. & .. & .. & <Random> & <DPP>
#
...
#
#   sh fcdef4.sh
#   DRY_RUN=1 sh fcdef4.sh    # print the defense.py commands and stop
