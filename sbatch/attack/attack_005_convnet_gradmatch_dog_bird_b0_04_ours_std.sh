...
#SBATCH --job-name=attack_005_convnet_gradmatch_dog_bird_b0_04_ours_std
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/attack_005_convnet_gradmatch_dog_bird_b0_04_ours_std-%j.out
...
# This-cell command: USE_JACOBIAN_SCORE=0 CLASS_PAIR="dog-bird" MODEL="ConvNetBN" ATTACK="gradmatch" BUDGETS=0.04 SELECT="ours" sh sel_dpp.sh

export JOB_KIND=attack
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR="dog-bird" MODEL="ConvNetBN" ATTACK="gradmatch" BUDGETS=0.04 SELECT="ours" sh sel_dpp.sh'
