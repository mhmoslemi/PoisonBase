...
#SBATCH --job-name=attack_026_convnet_sapa_frog_airplane_b0_02_ours_j
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/attack_026_convnet_sapa_frog_airplane_b0_02_ours_j-%j.out
...
# This-cell command: USE_JACOBIAN_SCORE=1 JACOBIAN_WEIGHT=1.0 JACOBIAN_BATCH_SIZE=64 CLASS_PAIR="frog-airplane" MODEL="ConvNetBN" ATTACK="sapa" SHARP_MODE="worst" SHARP_SIGMA="0.05" BUDGETS=0.02 SELECT="ours" sh sel_dpp.sh

export JOB_KIND=attack
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=1 JACOBIAN_WEIGHT=1.0 JACOBIAN_BATCH_SIZE=64 CLASS_PAIR="frog-airplane" MODEL="ConvNetBN" ATTACK="sapa" SHARP_MODE="worst" SHARP_SIGMA="0.05" BUDGETS=0.02 SELECT="ours" sh sel_dpp.sh'
