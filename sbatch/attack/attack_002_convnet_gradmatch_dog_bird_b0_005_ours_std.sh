...
#SBATCH --job-name=attack_002_convnet_gradmatch_dog_bird_b0_005_ours_std
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/attack_002_convnet_gradmatch_dog_bird_b0_005_ours_std-%j.out
...
# This-cell command: USE_JACOBIAN_SCORE=0 CLASS_PAIR="dog-bird" MODEL="ConvNetBN" ATTACK="gradmatch" BUDGETS=0.005 SELECT="ours" sh sel_dpp.sh

export JOB_KIND=attack
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR="dog-bird" MODEL="ConvNetBN" ATTACK="gradmatch" BUDGETS=0.005 SELECT="ours" sh sel_dpp.sh'
