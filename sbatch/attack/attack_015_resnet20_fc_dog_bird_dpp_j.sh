...
#SBATCH --job-name=attack_015_resnet20_fc_dog_bird_dpp_j
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/attack_015_resnet20_fc_dog_bird_dpp_j-%j.out
#SBATCH --mail-user=mhmoslemi2338@gmail.com
#SBATCH --mail-type=ALL

# Estimated L40S runtime: 0-02:45:00; requested walltime adds 00:45.
# Source command: USE_JACOBIAN_SCORE=1 JACOBIAN_WEIGHT=1.0 JACOBIAN_BATCH_SIZE=64 CLASS_PAIR="dog-bird" MODEL="ResNet20BN" ATTACK="fc" BUDGETS="0.001" SELECT="dpp" SEL_ALPHA=2.0 sh sel_dpp.sh
# Effective command: USE_JACOBIAN_SCORE=1 JACOBIAN_WEIGHT=1.0 JACOBIAN_BATCH_SIZE=64 CLASS_PAIR="dog-bird" MODEL="ResNet20BN" ATTACK="fc" BUDGETS="0.001" SELECT="dpp" SEL_ALPHA=2.0 sh sel_dpp.sh
