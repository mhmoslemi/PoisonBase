...
#SBATCH --job-name=k20v18_sapa_b0005_vconv_svgg_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/k20v18_sapa_b0005_vconv_svgg_k20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_norm_selarchVGG13BN_K20_worst0.05_ce5_tgt70
export ORIGINAL_COMMAND="attack=sapa budget=0.005 V=ConvNetBN S=VGG13BN K=20 base=ours base_dist=cosine_norm lambda_margin=1 jacobian=off craft_steps=250 victim_epochs=70 victim_decay=50 targets=10 victims=6; table lower-K=[23.3,20,31.7] old-K20=30"
