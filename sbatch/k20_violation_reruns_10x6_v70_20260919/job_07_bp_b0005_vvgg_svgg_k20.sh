...
#SBATCH --job-name=k20v07_bp_b0005_vvgg_svgg_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/k20v07_bp_b0005_vvgg_svgg_k20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_fc_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_norm_K20_ce5_tgt3
export ORIGINAL_COMMAND="attack=fc budget=0.005 V=VGG13BN S=VGG13BN K=20 base=ours base_dist=cosine_norm lambda_margin=1 jacobian=off craft_steps=250 victim_epochs=70 victim_decay=50 targets=10 victims=6; table lower-K=[55,50,60] old-K20=51.7"
