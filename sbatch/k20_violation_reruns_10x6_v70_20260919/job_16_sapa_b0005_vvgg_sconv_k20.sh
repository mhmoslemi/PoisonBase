...
#SBATCH --job-name=k20v16_sapa_b0005_vvgg_sconv_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/k20v16_sapa_b0005_vvgg_sconv_k20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_sapa_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_norm_selarchConvNetBN_K20_worst0.05_ce5_tgt50
export ORIGINAL_COMMAND="attack=sapa budget=0.005 V=VGG13BN S=ConvNetBN K=20 base=ours base_dist=cosine_norm lambda_margin=1 jacobian=off craft_steps=250 victim_epochs=70 victim_decay=50 targets=10 victims=6; table lower-K=[100,100,96.7] old-K20=95"
