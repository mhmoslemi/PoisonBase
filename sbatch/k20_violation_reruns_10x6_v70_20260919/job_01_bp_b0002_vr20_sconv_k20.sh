...
#SBATCH --job-name=k20v01_bp_b0002_vr20_sconv_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/k20v01_bp_b0002_vr20_sconv_k20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_norm_selarchConvNetBN_K20_ce5_tgt10
export ORIGINAL_COMMAND="attack=fc budget=0.002 V=ResNet20BN S=ConvNetBN K=20 base=ours base_dist=cosine_norm lambda_margin=1 jacobian=off craft_steps=250 victim_epochs=70 victim_decay=50 targets=10 victims=6; table lower-K=[30,40,36.7] old-K20=35"
