...
#SBATCH --job-name=score009_fc_b0002_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/score009_fc_b0002_similarity-target-margin-%j.out
