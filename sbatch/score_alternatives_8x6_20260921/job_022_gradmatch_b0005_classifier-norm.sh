...
#SBATCH --job-name=score022_gradmatch_b0005_classifier-norm
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/score022_gradmatch_b0005_classifier-norm-%j.out
