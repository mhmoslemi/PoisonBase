...
#SBATCH --job-name=score032_sapa_b0002_classifier-norm
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/score032_sapa_b0002_classifier-norm-%j.out
