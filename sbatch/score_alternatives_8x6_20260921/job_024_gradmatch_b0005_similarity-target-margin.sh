...
#SBATCH --job-name=score024_gradmatch_b0005_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/score024_gradmatch_b0005_similarity-target-margin-%j.out
