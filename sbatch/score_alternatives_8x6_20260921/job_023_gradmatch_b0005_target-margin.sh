...
#SBATCH --job-name=score023_gradmatch_b0005_target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/score023_gradmatch_b0005_target-margin-%j.out
