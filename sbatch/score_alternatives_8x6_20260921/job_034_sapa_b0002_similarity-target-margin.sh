...
#SBATCH --job-name=score034_sapa_b0002_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/score034_sapa_b0002_similarity-target-margin-%j.out
