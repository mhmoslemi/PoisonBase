...
#SBATCH --job-name=grn29_bp_b0005_vvgg_svgg_k1
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn29_bp_b0005_vvgg_svgg_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_fc_ours_dog-bird_b0.005_eps8_seed42_lam10_cosine_norm_K1_ce5_tgt3
export ORIGINAL_COMMAND="attack=fc budget=0.005 V=VGG13BN S=VGG13BN K=1 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=55"
