...
#SBATCH --job-name=grn32_gm_b0002_vconv_sconv_k1
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn32_gm_b0002_vconv_sconv_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam10_cosine_norm_K1_ce5_tgt70
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 V=ConvNetBN S=ConvNetBN K=1 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=23.3"
