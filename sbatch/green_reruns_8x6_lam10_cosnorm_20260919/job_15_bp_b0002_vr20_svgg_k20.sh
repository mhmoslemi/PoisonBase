...
#SBATCH --job-name=grn15_bp_b0002_vr20_svgg_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn15_bp_b0002_vr20_svgg_k20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_fc_ours_dog-bird_b0.002_eps8_seed42_lam10_cosine_norm_selarchVGG13BN_K20_ce5_tgt10
export ORIGINAL_COMMAND="attack=fc budget=0.002 V=ResNet20BN S=VGG13BN K=20 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=40"
