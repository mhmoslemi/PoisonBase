...
#SBATCH --job-name=grn06_bp_b0002_vvgg_sconv_k10
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn06_bp_b0002_vvgg_sconv_k10-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.002 V=VGG13BN S=ConvNetBN K=10 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=78.3"
