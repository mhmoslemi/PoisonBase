...
#SBATCH --job-name=grn26_bp_b0005_vconv_svgg_k1
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn26_bp_b0005_vconv_svgg_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_fc_ours_dog-bird_b0.005_eps8_seed42_lam10_cosine_norm_selarchVGG13BN_K1_ce5_tgt50
export ORIGINAL_COMMAND="attack=fc budget=0.005 V=ConvNetBN S=VGG13BN K=1 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=56.7"
