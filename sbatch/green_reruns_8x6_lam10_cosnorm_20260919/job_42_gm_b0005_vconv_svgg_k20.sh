...
#SBATCH --job-name=grn42_gm_b0005_vconv_svgg_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn42_gm_b0005_vconv_svgg_k20-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 V=ConvNetBN S=VGG13BN K=20 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=25"
