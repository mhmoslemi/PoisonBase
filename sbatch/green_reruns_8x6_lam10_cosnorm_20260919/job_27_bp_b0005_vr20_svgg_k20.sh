...
#SBATCH --job-name=grn27_bp_b0005_vr20_svgg_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn27_bp_b0005_vr20_svgg_k20-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 V=ResNet20BN S=VGG13BN K=20 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=30"
