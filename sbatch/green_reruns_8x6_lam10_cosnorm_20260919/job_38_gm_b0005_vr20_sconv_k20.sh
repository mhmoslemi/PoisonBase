...
#SBATCH --job-name=grn38_gm_b0005_vr20_sconv_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn38_gm_b0005_vr20_sconv_k20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.005_eps8_seed42_lam10_cosine_norm_selarchConvNetBN_K20_ce5_tgt14
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 V=ResNet20BN S=ConvNetBN K=20 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=85"
