...
#SBATCH --job-name=grn10_bp_b0002_vr20_sr20_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn10_bp_b0002_vr20_sr20_k3-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_fc_ours_dog-bird_b0.002_eps8_seed42_lam10_cosine_norm_K3_ce5_tgt10
export ORIGINAL_COMMAND="attack=fc budget=0.002 V=ResNet20BN S=ResNet20BN K=3 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=25"
