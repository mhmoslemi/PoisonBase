...
#SBATCH --job-name=grn52_sapa_b0002_vr20_svgg_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/grn52_sapa_b0002_vr20_svgg_k20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_sapa_ours_dog-bird_b0.002_eps8_seed42_lam10_cosine_norm_selarchVGG13BN_K20_worst0.05_ce5_tgt14
export ORIGINAL_COMMAND="attack=sapa budget=0.002 V=ResNet20BN S=VGG13BN K=20 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6; green-table-ASR=65"
