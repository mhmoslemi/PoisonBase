...
#SBATCH --job-name=ak119_gm_b0005_vconv_svgg_k10
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak119_gm_b0005_vconv_svgg_k10-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=ConvNetBN S=VGG13BN K=10 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
