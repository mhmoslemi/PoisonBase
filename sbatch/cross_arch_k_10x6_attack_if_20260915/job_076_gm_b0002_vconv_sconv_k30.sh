...
#SBATCH --job-name=ak076_gm_b0002_vconv_sconv_k30
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak076_gm_b0002_vconv_sconv_k30-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_K30_ce5_tgt70
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 A=V=ConvNetBN S=ConvNetBN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
