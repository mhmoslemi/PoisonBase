...
#SBATCH --job-name=ak174_sapa_b0002_vvgg_sr20_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak174_sapa_b0002_vvgg_sr20_k3-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=VGG13BN S=ResNet20BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
