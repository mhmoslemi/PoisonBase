...
#SBATCH --job-name=ak061_bp_b0005_vvgg_sconv_k1
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak061_bp_b0005_vvgg_sconv_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_fc_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selarchConvNetBN_K1_ce5_tgt3
export ORIGINAL_COMMAND="attack=fc budget=0.005 A=V=VGG13BN S=ConvNetBN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
