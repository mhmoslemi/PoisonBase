...
#SBATCH --job-name=ak012_bp_b0002_vconv_svgg_k30
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak012_bp_b0002_vconv_svgg_k30-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.002 A=V=ConvNetBN S=VGG13BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
