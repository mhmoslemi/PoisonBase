...
#SBATCH --job-name=ak147_sapa_b0002_vconv_sconv_k10
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak147_sapa_b0002_vconv_sconv_k10-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=ConvNetBN S=ConvNetBN K=10 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
