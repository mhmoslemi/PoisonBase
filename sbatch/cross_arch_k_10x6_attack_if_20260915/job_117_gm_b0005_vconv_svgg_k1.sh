...
#SBATCH --job-name=ak117_gm_b0005_vconv_svgg_k1
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak117_gm_b0005_vconv_svgg_k1-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=ConvNetBN S=VGG13BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
