...
#SBATCH --job-name=ak136_gm_b0005_vvgg_sconv_k30
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak136_gm_b0005_vvgg_sconv_k30-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=VGG13BN S=ConvNetBN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
