...
#SBATCH --job-name=ak154_sapa_b0002_vconv_svgg_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak154_sapa_b0002_vconv_svgg_k3-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchVGG13BN_K3_worst0.05_ce5_tgt70
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=ConvNetBN S=VGG13BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
