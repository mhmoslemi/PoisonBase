...
#SBATCH --job-name=ak172_sapa_b0002_vvgg_sconv_k30
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak172_sapa_b0002_vvgg_sconv_k30-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=VGG13BN S=ConvNetBN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
