...
#SBATCH --job-name=ak091_gm_b0002_vr20_sr20_k10
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak091_gm_b0002_vr20_sr20_k10-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 A=V=ResNet20BN S=ResNet20BN K=10 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
