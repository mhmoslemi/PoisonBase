...
#SBATCH --job-name=ak178_sapa_b0002_vvgg_svgg_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak178_sapa_b0002_vvgg_svgg_k3-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_sapa_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_K3_worst0.05_ce5_tgt50
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=VGG13BN S=VGG13BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
