...
#SBATCH --job-name=ak014_bp_b0002_vr20_sconv_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak014_bp_b0002_vr20_sconv_k3-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.002 A=V=ResNet20BN S=ConvNetBN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
