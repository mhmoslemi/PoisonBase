...
#SBATCH --job-name=ak202_sapa_b0005_vr20_svgg_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak202_sapa_b0005_vr20_svgg_k3-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_sapa_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selarchVGG13BN_K3_worst0.05_ce5_tgt14
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=ResNet20BN S=VGG13BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
