...
#SBATCH --job-name=ak161_sapa_b0002_vr20_sr20_k1
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak161_sapa_b0002_vr20_sr20_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_sapa_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_K1_worst0.05_ce5_tgt14
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=ResNet20BN S=ResNet20BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
