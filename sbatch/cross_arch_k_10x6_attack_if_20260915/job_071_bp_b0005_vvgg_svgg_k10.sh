...
#SBATCH --job-name=ak071_bp_b0005_vvgg_svgg_k10
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak071_bp_b0005_vvgg_svgg_k10-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 A=V=VGG13BN S=VGG13BN K=10 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
