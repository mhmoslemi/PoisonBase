...
#SBATCH --job-name=ak026_bp_b0002_vvgg_sconv_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak026_bp_b0002_vvgg_sconv_k3-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.002 A=V=VGG13BN S=ConvNetBN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
