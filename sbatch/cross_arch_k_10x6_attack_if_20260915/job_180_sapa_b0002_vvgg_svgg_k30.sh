...
#SBATCH --job-name=ak180_sapa_b0002_vvgg_svgg_k30
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak180_sapa_b0002_vvgg_svgg_k30-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=VGG13BN S=VGG13BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
