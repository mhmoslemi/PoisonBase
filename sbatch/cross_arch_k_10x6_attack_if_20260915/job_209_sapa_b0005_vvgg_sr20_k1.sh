...
#SBATCH --job-name=ak209_sapa_b0005_vvgg_sr20_k1
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak209_sapa_b0005_vvgg_sr20_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_sapa_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selarchResNet20BN_K1_worst0.05_ce5_tgt50
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=VGG13BN S=ResNet20BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
