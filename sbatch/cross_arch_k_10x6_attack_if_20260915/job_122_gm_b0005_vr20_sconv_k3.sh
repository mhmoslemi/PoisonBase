...
#SBATCH --job-name=ak122_gm_b0005_vr20_sconv_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak122_gm_b0005_vr20_sconv_k3-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selarchConvNetBN_K3_ce5_tgt14
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=ResNet20BN S=ConvNetBN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
