...
#SBATCH --job-name=ak097_gm_b0002_vvgg_sconv_k1
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak097_gm_b0002_vvgg_sconv_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchConvNetBN_K1_ce5_tgt50
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 A=V=VGG13BN S=ConvNetBN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
