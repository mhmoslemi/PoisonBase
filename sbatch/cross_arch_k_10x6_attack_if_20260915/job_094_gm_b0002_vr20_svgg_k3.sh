...
#SBATCH --job-name=ak094_gm_b0002_vr20_svgg_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak094_gm_b0002_vr20_svgg_k3-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchVGG13BN_K3_ce5_tgt14
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 A=V=ResNet20BN S=VGG13BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
