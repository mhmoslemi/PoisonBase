...
#SBATCH --job-name=ak142_gm_b0005_vvgg_svgg_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak142_gm_b0005_vvgg_svgg_k3-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=VGG13BN S=VGG13BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
