...
#SBATCH --job-name=ak092_gm_b0002_vr20_sr20_k30
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak092_gm_b0002_vr20_sr20_k30-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_K30_ce5_tgt14
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 A=V=ResNet20BN S=ResNet20BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
