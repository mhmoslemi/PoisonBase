...
#SBATCH --job-name=ak206_sapa_b0005_vvgg_sconv_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak206_sapa_b0005_vvgg_sconv_k3-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=VGG13BN S=ConvNetBN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
