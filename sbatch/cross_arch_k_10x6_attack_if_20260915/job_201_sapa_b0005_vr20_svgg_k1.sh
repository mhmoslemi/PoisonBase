...
#SBATCH --job-name=ak201_sapa_b0005_vr20_svgg_k1
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak201_sapa_b0005_vr20_svgg_k1-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=ResNet20BN S=VGG13BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
