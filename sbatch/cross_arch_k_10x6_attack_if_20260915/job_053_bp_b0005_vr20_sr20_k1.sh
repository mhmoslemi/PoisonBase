...
#SBATCH --job-name=ak053_bp_b0005_vr20_sr20_k1
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak053_bp_b0005_vr20_sr20_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_fc_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_K1_ce5_tgt10
export ORIGINAL_COMMAND="attack=fc budget=0.005 A=V=ResNet20BN S=ResNet20BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
