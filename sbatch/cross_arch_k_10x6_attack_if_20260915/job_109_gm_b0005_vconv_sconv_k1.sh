...
#SBATCH --job-name=ak109_gm_b0005_vconv_sconv_k1
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak109_gm_b0005_vconv_sconv_k1-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_gradmatch_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_K1_ce5_tgt70
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=ConvNetBN S=ConvNetBN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
