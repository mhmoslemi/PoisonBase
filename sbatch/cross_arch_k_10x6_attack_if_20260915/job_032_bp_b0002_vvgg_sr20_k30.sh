...
#SBATCH --job-name=ak032_bp_b0002_vvgg_sr20_k30
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak032_bp_b0002_vvgg_sr20_k30-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchResNet20BN_K30_ce5_tgt3
export ORIGINAL_COMMAND="attack=fc budget=0.002 A=V=VGG13BN S=ResNet20BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
