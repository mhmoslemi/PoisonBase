...
#SBATCH --job-name=ak048_bp_b0005_vconv_svgg_k30
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak048_bp_b0005_vconv_svgg_k30-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 A=V=ConvNetBN S=VGG13BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
