...
#SBATCH --job-name=ak042_bp_b0005_vconv_sr20_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak042_bp_b0005_vconv_sr20_k3-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 A=V=ConvNetBN S=ResNet20BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
