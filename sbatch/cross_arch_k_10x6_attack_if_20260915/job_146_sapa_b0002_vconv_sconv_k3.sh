...
#SBATCH --job-name=ak146_sapa_b0002_vconv_sconv_k3
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak146_sapa_b0002_vconv_sconv_k3-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=ConvNetBN S=ConvNetBN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
