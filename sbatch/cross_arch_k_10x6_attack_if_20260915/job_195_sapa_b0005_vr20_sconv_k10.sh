...
#SBATCH --job-name=ak195_sapa_b0005_vr20_sconv_k10
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak195_sapa_b0005_vr20_sconv_k10-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=ResNet20BN S=ConvNetBN K=10 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
