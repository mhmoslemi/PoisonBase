...
#SBATCH --job-name=ak111_gm_b0005_vconv_sconv_k10
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ak111_gm_b0005_vconv_sconv_k10-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=ConvNetBN S=ConvNetBN K=10 base=ours jacobian=off craft_steps=250 targets=10 victims=6 profile=attack_if"
