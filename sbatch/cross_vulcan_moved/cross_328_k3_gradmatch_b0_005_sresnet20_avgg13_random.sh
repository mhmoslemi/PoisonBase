...
#SBATCH --job-name=cross_328_k3_gradmatch_b0_005_sresnet20_avgg13_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/cross_328_k3_gradmatch_b0_005_sresnet20_avgg13_random-%j.out
