...
#SBATCH --job-name=xk100_gm_b0002_vvgg_sconv_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk100_gm_b0002_vvgg_sconv_k30-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 A=V=VGG13BN S=ConvNetBN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
