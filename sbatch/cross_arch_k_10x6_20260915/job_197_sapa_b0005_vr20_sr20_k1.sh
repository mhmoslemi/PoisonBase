...
#SBATCH --job-name=xk197_sapa_b0005_vr20_sr20_k1
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk197_sapa_b0005_vr20_sr20_k1-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=ResNet20BN S=ResNet20BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
