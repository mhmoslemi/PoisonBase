...
#SBATCH --job-name=xk114_gm_b0005_vconv_sr20_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk114_gm_b0005_vconv_sr20_k3-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=ConvNetBN S=ResNet20BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
