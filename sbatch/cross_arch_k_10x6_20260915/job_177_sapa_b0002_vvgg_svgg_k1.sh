...
#SBATCH --job-name=xk177_sapa_b0002_vvgg_svgg_k1
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk177_sapa_b0002_vvgg_svgg_k1-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=VGG13BN S=VGG13BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
