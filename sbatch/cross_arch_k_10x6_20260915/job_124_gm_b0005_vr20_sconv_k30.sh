...
#SBATCH --job-name=xk124_gm_b0005_vr20_sconv_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk124_gm_b0005_vr20_sconv_k30-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=ResNet20BN S=ConvNetBN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
