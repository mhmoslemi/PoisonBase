...
#SBATCH --job-name=xk065_bp_b0005_vvgg_sr20_k1
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk065_bp_b0005_vvgg_sr20_k1-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 A=V=VGG13BN S=ResNet20BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
