...
#SBATCH --job-name=xk060_bp_b0005_vr20_svgg_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk060_bp_b0005_vr20_svgg_k30-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 A=V=ResNet20BN S=VGG13BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
