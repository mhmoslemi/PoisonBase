...
#SBATCH --job-name=xk074_gm_b0002_vconv_sconv_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk074_gm_b0002_vconv_sconv_k3-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 A=V=ConvNetBN S=ConvNetBN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
