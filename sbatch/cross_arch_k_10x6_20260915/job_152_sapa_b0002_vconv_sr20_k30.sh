...
#SBATCH --job-name=xk152_sapa_b0002_vconv_sr20_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk152_sapa_b0002_vconv_sr20_k30-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=ConvNetBN S=ResNet20BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
