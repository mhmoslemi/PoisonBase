...
#SBATCH --job-name=xk192_sapa_b0005_vconv_svgg_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk192_sapa_b0005_vconv_svgg_k30-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=ConvNetBN S=VGG13BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
