...
#SBATCH --job-name=xk175_sapa_b0002_vvgg_sr20_k10
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk175_sapa_b0002_vvgg_sr20_k10-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=VGG13BN S=ResNet20BN K=10 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
