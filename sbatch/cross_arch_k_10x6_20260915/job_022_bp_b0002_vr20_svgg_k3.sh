...
#SBATCH --job-name=xk022_bp_b0002_vr20_svgg_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk022_bp_b0002_vr20_svgg_k3-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.002 A=V=ResNet20BN S=VGG13BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
