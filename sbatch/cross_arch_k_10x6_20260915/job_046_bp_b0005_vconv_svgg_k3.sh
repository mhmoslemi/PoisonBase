...
#SBATCH --job-name=xk046_bp_b0005_vconv_svgg_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk046_bp_b0005_vconv_svgg_k3-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 A=V=ConvNetBN S=VGG13BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
