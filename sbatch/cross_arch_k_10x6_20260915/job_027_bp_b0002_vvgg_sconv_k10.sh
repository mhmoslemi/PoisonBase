...
#SBATCH --job-name=xk027_bp_b0002_vvgg_sconv_k10
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xk027_bp_b0002_vvgg_sconv_k10-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.002 A=V=VGG13BN S=ConvNetBN K=10 base=ours jacobian=off craft_steps=250 targets=10 victims=6"
