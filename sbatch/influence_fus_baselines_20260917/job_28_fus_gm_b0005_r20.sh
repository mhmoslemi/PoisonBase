...
#SBATCH --job-name=ifb28_fus_gm_b0005_r20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/ifb28_fus_gm_b0005_r20-%A_%a.out
...
export ORIGINAL_COMMAND="selector=fus attack=gradmatch budget=0.005 model=ResNet20BN K=20 dog-bird targets=10 victims=6 craft_steps=250 parts=4"
