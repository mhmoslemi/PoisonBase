...
#SBATCH --job-name=ifb16_grad_sapa_b0005_r20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/ifb16_grad_sapa_b0005_r20-%j.out
...
export ORIGINAL_COMMAND="selector=gao-gradnorm attack=sapa budget=0.005 model=ResNet20BN K=20 dog-bird targets=10 victims=6 craft_steps=250"
