...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/ifb26_fus_gm_b0002_r20-%A_%a.out
...
export ORIGINAL_COMMAND="selector=fus attack=gradmatch budget=0.002 model=ResNet20BN K=20 dog-bird targets=10 victims=6 craft_steps=250 parts=4"
