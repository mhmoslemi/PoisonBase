...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/ifb25_fus_gm_b0002_conv-%A_%a.out
...
export ORIGINAL_COMMAND="selector=fus attack=gradmatch budget=0.002 model=ConvNetBN K=20 dog-bird targets=10 victims=6 craft_steps=250 parts=4"
