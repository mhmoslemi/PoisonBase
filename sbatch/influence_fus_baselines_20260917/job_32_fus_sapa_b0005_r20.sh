...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/ifb32_fus_sapa_b0005_r20-%j.out
...
export ORIGINAL_COMMAND="selector=fus attack=sapa budget=0.005 model=ResNet20BN K=20 dog-bird targets=10 victims=6 craft_steps=250"
