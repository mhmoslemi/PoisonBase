...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/ifb27_fus_gm_b0005_conv-%A_%a.out
...
export ORIGINAL_COMMAND="selector=fus attack=gradmatch budget=0.005 model=ConvNetBN K=20 dog-bird targets=10 victims=6 craft_steps=250 parts=4"
