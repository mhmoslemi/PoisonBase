...
#SBATCH --job-name=ascore039_sapa_b0005_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore039_sapa_b0005_similarity-target-margin-%j.out
