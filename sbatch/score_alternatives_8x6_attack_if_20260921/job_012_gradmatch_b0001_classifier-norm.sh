...
#SBATCH --job-name=ascore012_gradmatch_b0001_classifier-norm
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore012_gradmatch_b0001_classifier-norm-%j.out
