...
#SBATCH --job-name=ascore023_gradmatch_b0005_target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore023_gradmatch_b0005_target-margin-%j.out
