...
#SBATCH --job-name=ascore016_gradmatch_b0002_classifier
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore016_gradmatch_b0002_classifier-%j.out
