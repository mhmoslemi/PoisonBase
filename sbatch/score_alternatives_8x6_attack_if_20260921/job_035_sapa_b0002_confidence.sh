...
#SBATCH --job-name=ascore035_sapa_b0002_confidence
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore035_sapa_b0002_confidence-%j.out
