...
#SBATCH --job-name=ascore014_gradmatch_b0001_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore014_gradmatch_b0001_similarity-target-margin-%j.out

# One experiment: ConvNetBN / dog-bird / gradmatch / rho=0.001
