...
#SBATCH --job-name=ascore021_gradmatch_b0005_classifier
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore021_gradmatch_b0005_classifier-%j.out
