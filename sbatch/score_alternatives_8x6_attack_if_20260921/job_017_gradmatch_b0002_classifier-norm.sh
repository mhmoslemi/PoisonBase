...
#SBATCH --job-name=ascore017_gradmatch_b0002_classifier-norm
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore017_gradmatch_b0002_classifier-norm-%j.out
