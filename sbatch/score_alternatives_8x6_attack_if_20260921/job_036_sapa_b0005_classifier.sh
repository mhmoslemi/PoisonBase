...
#SBATCH --job-name=ascore036_sapa_b0005_classifier
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore036_sapa_b0005_classifier-%j.out
