...
#SBATCH --job-name=ascore020_gradmatch_b0002_confidence
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore020_gradmatch_b0002_confidence-%j.out
