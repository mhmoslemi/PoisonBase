...
#SBATCH --job-name=ascore022_gradmatch_b0005_classifier-norm
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore022_gradmatch_b0005_classifier-norm-%j.out
