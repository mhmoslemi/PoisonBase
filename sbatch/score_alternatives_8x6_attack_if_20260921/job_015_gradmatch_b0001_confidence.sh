...
#SBATCH --job-name=ascore015_gradmatch_b0001_confidence
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore015_gradmatch_b0001_confidence-%j.out
