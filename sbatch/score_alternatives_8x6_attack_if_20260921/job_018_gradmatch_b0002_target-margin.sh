...
#SBATCH --job-name=ascore018_gradmatch_b0002_target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore018_gradmatch_b0002_target-margin-%j.out
