...
#SBATCH --job-name=ascore019_gradmatch_b0002_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore019_gradmatch_b0002_similarity-target-margin-%j.out

# One experiment: ConvNetBN / dog-bird / gradmatch / rho=0.002
