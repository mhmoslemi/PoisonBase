...
#SBATCH --job-name=ascore034_sapa_b0002_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore034_sapa_b0002_similarity-target-margin-%j.out
