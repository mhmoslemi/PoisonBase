...
#SBATCH --job-name=ascore029_sapa_b0001_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore029_sapa_b0001_similarity-target-margin-%j.out

# One experiment: ConvNetBN / dog-bird / sapa / rho=0.001
