...
#SBATCH --job-name=ascore037_sapa_b0005_classifier-norm
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore037_sapa_b0005_classifier-norm-%j.out
