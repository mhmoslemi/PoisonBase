...
#SBATCH --job-name=ascore004_fc_b0001_similarity-target-margin
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore004_fc_b0001_similarity-target-margin-%j.out

# One experiment: ConvNetBN / dog-bird / fc / rho=0.001
