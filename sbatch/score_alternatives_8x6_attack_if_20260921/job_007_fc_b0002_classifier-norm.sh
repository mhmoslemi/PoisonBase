...
#SBATCH --job-name=ascore007_fc_b0002_classifier-norm
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ascore007_fc_b0002_classifier-norm-%j.out
