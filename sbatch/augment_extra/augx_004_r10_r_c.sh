...
#SBATCH --job-name=augx_004_r10_r_c
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ResNet20BN_sapa_random_dog-bird_b0.01_eps8_seed42_worst0.05_ce5_tgt14__def-none+aug-cutout'
export ORIGINAL_COMMAND='python defense.py --model ResNet20BN --attack sapa --selection random --budget 0.01 --victim_aug cutout --num_targets 5 --num_victims 4'
