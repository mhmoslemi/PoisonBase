...
#SBATCH --job-name=augx_148_r04_r_c
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ConvNetBN_gradmatch_random_dog-bird_b0.02_eps8_seed42_ce5_tgt70__def-none+aug-cutout'
export ORIGINAL_COMMAND='python defense.py --model ConvNetBN --attack gradmatch --selection random --budget 0.02 --victim_aug cutout --num_targets 5 --num_victims 4'
