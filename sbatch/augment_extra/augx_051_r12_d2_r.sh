...
#SBATCH --job-name=augx_051_r12_d2_r
...
export EXPECTED_DEFENSE_RUN='CIFAR10_VGG13BN_gradmatch_ours_dog-bird_b0.01_eps8_seed42_lam1_cosine_seldpp2_ce5_tgt50__def-none+aug-randaug'
export ORIGINAL_COMMAND='python defense.py --model VGG13BN --attack gradmatch --selection dpp2 --budget 0.01 --victim_aug randaug --num_targets 5 --num_victims 4'
