...
#SBATCH --job-name=augx_106_r01_d25_s
...
export ATTACK_RUN_NAME='CIFAR10_ConvNetBN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_seldpp0.25_ce5_tgt50'
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ConvNetBN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_seldpp0.25_ce5_tgt50__def-none+aug-standard'
export ORIGINAL_COMMAND='python defense.py --model ConvNetBN --attack fc --selection dpp025 --budget 0.002 --victim_aug standard --num_targets 5 --num_victims 4'
