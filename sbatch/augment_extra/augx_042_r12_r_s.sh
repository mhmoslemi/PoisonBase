...
#SBATCH --job-name=augx_042_r12_r_s
...
export ATTACK_RUN_NAME='CIFAR10_VGG13BN_gradmatch_random_dog-bird_b0.01_eps8_seed42_ce5_tgt50'
...
export EXPECTED_DEFENSE_RUN='CIFAR10_VGG13BN_gradmatch_random_dog-bird_b0.01_eps8_seed42_ce5_tgt50__def-none+aug-standard'
export ORIGINAL_COMMAND='python defense.py --model VGG13BN --attack gradmatch --selection random --budget 0.01 --victim_aug standard --num_targets 5 --num_victims 4'
