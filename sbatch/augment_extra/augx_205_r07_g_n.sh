...
#SBATCH --job-name=augx_205_r07_g_n
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_ce5_tgt14__def-none'
export ORIGINAL_COMMAND='python defense.py --model ResNet20BN --attack gradmatch --selection greedy --budget 0.002 --victim_aug none --num_targets 5 --num_victims 4'
