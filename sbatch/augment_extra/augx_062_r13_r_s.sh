...
#SBATCH --job-name=augx_062_r13_r_s
...
export ATTACK_RUN_NAME='CIFAR10_VGG13BN_sapa_random_dog-bird_b0.005_eps8_seed42_worst0.05_ce5_tgt50'
...
export EXPECTED_DEFENSE_RUN='CIFAR10_VGG13BN_sapa_random_dog-bird_b0.005_eps8_seed42_worst0.05_ce5_tgt50__def-none+aug-standard'
export ORIGINAL_COMMAND='python defense.py --model VGG13BN --attack sapa --selection random --budget 0.005 --victim_aug standard --num_targets 5 --num_victims 4'
