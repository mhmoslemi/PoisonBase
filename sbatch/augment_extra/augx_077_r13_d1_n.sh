...
#SBATCH --job-name=augx_077_r13_d1_n
...
export EXPECTED_DEFENSE_RUN='CIFAR10_VGG13BN_sapa_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_seldpp0.1_worst0.05_ce5_tgt50__def-none'
export ORIGINAL_COMMAND='python defense.py --model VGG13BN --attack sapa --selection dpp01 --budget 0.005 --victim_aug none --num_targets 5 --num_victims 4'
