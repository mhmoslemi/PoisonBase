...
#SBATCH --job-name=augx_076_r13_d25_c
...
export EXPECTED_DEFENSE_RUN='CIFAR10_VGG13BN_sapa_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_seldpp0.25_worst0.05_ce5_tgt50__def-none+aug-cutout'
export ORIGINAL_COMMAND='python defense.py --model VGG13BN --attack sapa --selection dpp025 --budget 0.005 --victim_aug cutout --num_targets 5 --num_victims 4'
