...
#SBATCH --job-name=augx_177_r05_d25_n
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_seldpp0.25_worst0.05_ce5_tgt70__def-none'
export ORIGINAL_COMMAND='python defense.py --model ConvNetBN --attack sapa --selection dpp025 --budget 0.02 --victim_aug none --num_targets 5 --num_victims 4'
