...
#SBATCH --job-name=augx_244_r09_d25_c
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_seldpp0.25_ce5_tgt14__def-none+aug-cutout'
export ORIGINAL_COMMAND='python defense.py --model ResNet20BN --attack gradmatch --selection dpp025 --budget 0.02 --victim_aug cutout --num_targets 5 --num_victims 4'
