...
#SBATCH --job-name=augx_240_r09_g_c
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_ce5_tgt14__def-none+aug-cutout'
export ORIGINAL_COMMAND='python defense.py --model ResNet20BN --attack gradmatch --selection greedy --budget 0.02 --victim_aug cutout --num_targets 5 --num_victims 4'
