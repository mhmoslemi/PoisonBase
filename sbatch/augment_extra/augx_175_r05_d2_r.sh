...
#SBATCH --job-name=augx_175_r05_d2_r
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_seldpp2_worst0.05_ce5_tgt70__def-none+aug-randaug'
export ORIGINAL_COMMAND='python defense.py --model ConvNetBN --attack sapa --selection dpp2 --budget 0.02 --victim_aug randaug --num_targets 5 --num_victims 4'
