...
#SBATCH --job-name=augx_166_r05_r_s
...
export ATTACK_RUN_NAME='CIFAR10_ConvNetBN_sapa_random_dog-bird_b0.02_eps8_seed42_worst0.05_ce5_tgt70'
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ConvNetBN_sapa_random_dog-bird_b0.02_eps8_seed42_worst0.05_ce5_tgt70__def-none+aug-standard'
export ORIGINAL_COMMAND='python defense.py --model ConvNetBN --attack sapa --selection random --budget 0.02 --victim_aug standard --num_targets 5 --num_victims 4'
