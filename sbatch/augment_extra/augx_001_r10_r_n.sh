...
#SBATCH --job-name=augx_001_r10_r_n
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ResNet20BN_sapa_random_dog-bird_b0.01_eps8_seed42_worst0.05_ce5_tgt14__def-none'
export ORIGINAL_COMMAND='python defense.py --model ResNet20BN --attack sapa --selection random --budget 0.01 --victim_aug none --num_targets 5 --num_victims 4'
