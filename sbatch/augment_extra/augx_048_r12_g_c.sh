...
#SBATCH --job-name=augx_048_r12_g_c
...
export EXPECTED_DEFENSE_RUN='CIFAR10_VGG13BN_gradmatch_ours_dog-bird_b0.01_eps8_seed42_lam1_cosine_ce5_tgt50__def-none+aug-cutout'
export ORIGINAL_COMMAND='python defense.py --model VGG13BN --attack gradmatch --selection greedy --budget 0.01 --victim_aug cutout --num_targets 5 --num_victims 4'
