...
#SBATCH --job-name=augx_109_r01_d1_n
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ConvNetBN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_seldpp0.1_ce5_tgt50__def-none'
export ORIGINAL_COMMAND='python defense.py --model ConvNetBN --attack fc --selection dpp01 --budget 0.002 --victim_aug none --num_targets 5 --num_victims 4'
