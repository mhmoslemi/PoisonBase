...
#SBATCH --job-name=augx_054_r12_d25_s
...
export ATTACK_RUN_NAME='CIFAR10_VGG13BN_gradmatch_ours_dog-bird_b0.01_eps8_seed42_lam1_cosine_seldpp0.25_ce5_tgt50'
...
export EXPECTED_DEFENSE_RUN='CIFAR10_VGG13BN_gradmatch_ours_dog-bird_b0.01_eps8_seed42_lam1_cosine_seldpp0.25_ce5_tgt50__def-none+aug-standard'
export ORIGINAL_COMMAND='python defense.py --model VGG13BN --attack gradmatch --selection dpp025 --budget 0.01 --victim_aug standard --num_targets 5 --num_victims 4'
