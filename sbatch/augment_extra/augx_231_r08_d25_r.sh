...
#SBATCH --job-name=augx_231_r08_d25_r
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.01_eps8_seed42_lam1_cosine_seldpp0.25_ce5_tgt14__def-none+aug-randaug'
export ORIGINAL_COMMAND='python defense.py --model ResNet20BN --attack gradmatch --selection dpp025 --budget 0.01 --victim_aug randaug --num_targets 5 --num_victims 4'
