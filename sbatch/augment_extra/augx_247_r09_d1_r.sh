...
#SBATCH --job-name=augx_247_r09_d1_r
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_seldpp0.1_ce5_tgt14__def-none+aug-randaug'
export ORIGINAL_COMMAND='python defense.py --model ResNet20BN --attack gradmatch --selection dpp01 --budget 0.02 --victim_aug randaug --num_targets 5 --num_victims 4'
