...
#SBATCH --job-name=augx_184_r05_d1_c
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_seldpp0.1_worst0.05_ce5_tgt70__def-none+aug-cutout'
export ORIGINAL_COMMAND='python defense.py --model ConvNetBN --attack sapa --selection dpp01 --budget 0.02 --victim_aug cutout --num_targets 5 --num_victims 4'
