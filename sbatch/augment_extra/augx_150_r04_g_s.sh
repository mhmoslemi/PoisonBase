...
#SBATCH --job-name=augx_150_r04_g_s
...
export ATTACK_RUN_NAME='CIFAR10_ConvNetBN_gradmatch_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_ce5_tgt70'
...
export EXPECTED_DEFENSE_RUN='CIFAR10_ConvNetBN_gradmatch_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_ce5_tgt70__def-none+aug-standard'
export ORIGINAL_COMMAND='python defense.py --model ConvNetBN --attack gradmatch --selection greedy --budget 0.02 --victim_aug standard --num_targets 5 --num_victims 4'
