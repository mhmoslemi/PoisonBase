...
#SBATCH --job-name=augx_043_r12_r_r
...
export EXPECTED_DEFENSE_RUN='CIFAR10_VGG13BN_gradmatch_random_dog-bird_b0.01_eps8_seed42_ce5_tgt50__def-none+aug-randaug'
export ORIGINAL_COMMAND='python defense.py --model VGG13BN --attack gradmatch --selection random --budget 0.01 --victim_aug randaug --num_targets 5 --num_victims 4'
