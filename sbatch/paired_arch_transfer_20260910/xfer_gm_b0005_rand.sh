...
#SBATCH --job-name=xfer_gm_b0005_rand
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xfer_gm_b0005_rand-%j.out
...
export XFER_RUN_NAME=CIFAR10_ConvNetBN_gradmatch_random_dog-bird_b0.005_eps8_seed42_K20_ce5_tgt70
export ORIGINAL_COMMAND="A=V=ConvNetBN S=shared K=20 attack=gradmatch selection=RAND budget=0.005 targets=6 victims=6"
