...
#SBATCH --job-name=xfer_sapa_b0001_basis_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xfer_sapa_b0001_basis_svgg-%j.out
...
export XFER_RUN_NAME=CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.001_eps8_seed42_lam1_cosine_selarchVGG13BN_K20_worst0.05_ce5_tgt70
export ORIGINAL_COMMAND="A=V=ConvNetBN S=VGG13BN K=20 attack=sapa selection=BASIS budget=0.001 targets=6 victims=6"
