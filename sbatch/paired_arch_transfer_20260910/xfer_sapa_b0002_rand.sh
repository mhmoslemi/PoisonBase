...
#SBATCH --job-name=xfer_sapa_b0002_rand
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xfer_sapa_b0002_rand-%j.out
...
export XFER_RUN_NAME=CIFAR10_ConvNetBN_sapa_random_dog-bird_b0.002_eps8_seed42_K20_worst0.05_ce5_tgt70
export ORIGINAL_COMMAND="A=V=ConvNetBN S=shared K=20 attack=sapa selection=RAND budget=0.002 targets=6 victims=6"
