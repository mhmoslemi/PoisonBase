...
#SBATCH --job-name=pr048_k30_gm_b0005_vr20_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/pr048_k30_gm_b0005_vr20_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.005 V=ResNet20BN S=ConvNetBN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6"
