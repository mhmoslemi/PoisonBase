...
#SBATCH --job-name=pr005_m_r20_sapa_b0002
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/pr005_m_r20_sapa_b0002-%j.out
...
export ORIGINAL_COMMAND="category=component attack=sapa budget=0.002 V=ResNet20BN S=ResNet20BN K=20 component=minus-m base=ours jacobian=off craft_steps=250 targets=8 victims=6"
