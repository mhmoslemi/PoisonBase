...
#SBATCH --job-name=pr034_k3_gm_b0002_vconv_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/pr034_k3_gm_b0002_vconv_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.002 V=ConvNetBN S=ConvNetBN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6"
