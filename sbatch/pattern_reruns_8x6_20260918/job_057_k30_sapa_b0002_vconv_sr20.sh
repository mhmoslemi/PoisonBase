...
#SBATCH --job-name=pr057_k30_sapa_b0002_vconv_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/pr057_k30_sapa_b0002_vconv_sr20-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.002 V=ConvNetBN S=ResNet20BN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6"
