...
#SBATCH --job-name=pr040_k10_gm_b0002_vvgg_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/pr040_k10_gm_b0002_vvgg_sr20-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.002 V=VGG13BN S=ResNet20BN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6"
