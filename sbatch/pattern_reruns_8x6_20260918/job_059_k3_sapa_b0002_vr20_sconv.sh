...
#SBATCH --job-name=pr059_k3_sapa_b0002_vr20_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/pr059_k3_sapa_b0002_vr20_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.002 V=ResNet20BN S=ConvNetBN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6"
