...
#SBATCH --job-name=pr014_k3_bp_b0002_vr20_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/pr014_k3_bp_b0002_vr20_svgg-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.002 V=ResNet20BN S=VGG13BN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6"
