...
#SBATCH --job-name=b0_0005_frog_airplane_convnet_gradmatch
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/b0_0005_frog_airplane_convnet_gradmatch-%j.out
