...
#SBATCH --job-name=b0_0005_frog_airplane_resnet20_gradmatch
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/b0_0005_frog_airplane_resnet20_gradmatch-%j.out
