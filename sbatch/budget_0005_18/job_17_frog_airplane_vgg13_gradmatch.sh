...
#SBATCH --job-name=b0_0005_frog_airplane_vgg13_gradmatch
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/b0_0005_frog_airplane_vgg13_gradmatch-%j.out
