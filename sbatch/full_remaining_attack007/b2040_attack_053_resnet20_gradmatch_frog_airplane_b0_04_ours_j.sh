...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs2/b2040_attack_053_resnet20_gradmatch_frog_airplane_b0_04_ours_j-%j.out
...
# Exactly one table cell: USE_JACOBIAN_SCORE=1 JACOBIAN_WEIGHT=1.0 JACOBIAN_BATCH_SIZE=64 CLASS_PAIR=frog-airplane MODEL=ResNet20BN ATTACK=gradmatch BUDGETS=0.04 SELECT=ours SEL_ALPHA=2.0 NUM_TARGETS=8 NUM_VICTIMS=6 sh sel_dpp.sh
...
export RESUME_RUN_NAME='CIFAR10_ResNet20BN_gradmatch_ours_frog-airplane_b0.04_eps8_seed42_lam1_cosine_jacw1_ce5_tgt10'
