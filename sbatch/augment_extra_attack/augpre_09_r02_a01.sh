...
#SBATCH --job-name=augpre_09_r02_a01
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ConvNetBN ATTACK=fc TARGET_SELECT=50 BUDGETS=0.01 SELECT=dpp SEL_ALPHA=0.1 NUM_TARGETS=7 NUM_VICTIMS=1 sh sel_dpp.sh'
...
export EXPECTED_RUN_NAME='CIFAR10_ConvNetBN_fc_ours_dog-bird_b0.01_eps8_seed42_lam1_cosine_seldpp0.1_ce5_tgt50'
