...
#SBATCH --job-name=augpre_04_r09_a025
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ResNet20BN ATTACK=gradmatch TARGET_SELECT=14 BUDGETS=0.02 SELECT=dpp SEL_ALPHA=0.25 NUM_TARGETS=6 NUM_VICTIMS=1 sh sel_dpp.sh'
...
export EXPECTED_RUN_NAME='CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.02_eps8_seed42_lam1_cosine_seldpp0.25_ce5_tgt14'
