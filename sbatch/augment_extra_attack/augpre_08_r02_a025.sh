...
#SBATCH --job-name=augpre_08_r02_a025
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ConvNetBN ATTACK=fc TARGET_SELECT=50 BUDGETS=0.01 SELECT=dpp SEL_ALPHA=0.25 NUM_TARGETS=7 NUM_VICTIMS=1 sh sel_dpp.sh'
...
export PREREQ_ROW=02
export EXPECTED_RUN_NAME='CIFAR10_ConvNetBN_fc_ours_dog-bird_b0.01_eps8_seed42_lam1_cosine_seldpp0.25_ce5_tgt50'
