...
#SBATCH --job-name=bkr013_k10_gm_b0002_vvgg_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/bkr013_k10_gm_b0002_vvgg_sr20-%j.out
...
export ORIGINAL_COMMAND="category=k_pattern attack=gradmatch budget=0.002 V=VGG13BN S=ResNet20BN K=10 base=ours base_dist=cosine lambda_margin=1 jacobian=off craft_steps=250 targets=10 victims=6; table K10=76.7 exceeds fixed K20=75"
