...
#SBATCH --job-name=bkr023_k3_bp_b0002_vr20_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/bkr023_k3_bp_b0002_vr20_svgg-%j.out
...
export ORIGINAL_COMMAND="category=ensemble_below_rand attack=fc budget=0.002 V=ResNet20BN S=VGG13BN K=3 base=ours base_dist=cosine lambda_margin=1 jacobian=off craft_steps=250 targets=10 victims=6; table BASIS=13.3 below RAND=16.7"
