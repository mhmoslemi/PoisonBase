...
#SBATCH --job-name=bkr010_k10_gm_b0002_vr20_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/bkr010_k10_gm_b0002_vr20_sconv-%j.out
...
export ORIGINAL_COMMAND="category=k_pattern attack=gradmatch budget=0.002 V=ResNet20BN S=ConvNetBN K=10 base=ours base_dist=cosine lambda_margin=1 jacobian=off craft_steps=250 targets=10 victims=6; table K10=56.7 exceeds fixed K20=55"
