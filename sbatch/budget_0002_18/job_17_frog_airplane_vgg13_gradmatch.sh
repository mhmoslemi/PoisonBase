...
#SBATCH --job-name=b0002_frog_airplane_vgg13_gradmatch
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/b0002_frog_airplane_vgg13_gradmatch-%j.out
