...
#SBATCH --job-name=ar015_k30_bp_b0002_vr20_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar015_k30_bp_b0002_vr20_svgg-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchVGG13BN_K30_ce5_tgt10
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.002 V=ResNet20BN S=VGG13BN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
