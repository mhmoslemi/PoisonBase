...
#SBATCH --job-name=ar054_k3_sapa_b0002_vconv_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar054_k3_sapa_b0002_vconv_sconv-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_K3_worst0.05_ce5_tgt70
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.002 V=ConvNetBN S=ConvNetBN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
