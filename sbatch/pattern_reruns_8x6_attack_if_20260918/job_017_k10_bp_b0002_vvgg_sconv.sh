...
#SBATCH --job-name=ar017_k10_bp_b0002_vvgg_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar017_k10_bp_b0002_vvgg_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.002 V=VGG13BN S=ConvNetBN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
