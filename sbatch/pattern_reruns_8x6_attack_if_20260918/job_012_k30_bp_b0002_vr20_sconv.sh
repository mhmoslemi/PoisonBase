...
#SBATCH --job-name=ar012_k30_bp_b0002_vr20_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar012_k30_bp_b0002_vr20_sconv-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchConvNetBN_K30_ce5_tgt10
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.002 V=ResNet20BN S=ConvNetBN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
