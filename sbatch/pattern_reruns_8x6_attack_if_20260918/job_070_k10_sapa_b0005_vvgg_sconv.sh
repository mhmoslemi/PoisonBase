...
#SBATCH --job-name=ar070_k10_sapa_b0005_vvgg_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar070_k10_sapa_b0005_vvgg_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.005 V=VGG13BN S=ConvNetBN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
