...
#SBATCH --job-name=ar060_k10_sapa_b0002_vr20_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar060_k10_sapa_b0002_vr20_sr20-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.002 V=ResNet20BN S=ResNet20BN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
