...
#SBATCH --job-name=ar071_k10_sapa_b0005_vvgg_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar071_k10_sapa_b0005_vvgg_sr20-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.005 V=VGG13BN S=ResNet20BN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
