...
#SBATCH --job-name=ar021_k3_bp_b0005_vconv_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar021_k3_bp_b0005_vconv_svgg-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.005 V=ConvNetBN S=VGG13BN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
