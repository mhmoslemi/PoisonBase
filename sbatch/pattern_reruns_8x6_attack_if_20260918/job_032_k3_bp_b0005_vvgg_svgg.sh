...
#SBATCH --job-name=ar032_k3_bp_b0005_vvgg_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar032_k3_bp_b0005_vvgg_svgg-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_fc_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_K3_ce5_tgt3
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.005 V=VGG13BN S=VGG13BN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
