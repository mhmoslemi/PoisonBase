...
#SBATCH --job-name=ar051_k3_gm_b0005_vvgg_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar051_k3_gm_b0005_vvgg_sconv-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_gradmatch_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selarchConvNetBN_K3_ce5_tgt50
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.005 V=VGG13BN S=ConvNetBN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
