...
#SBATCH --job-name=ar001_m_conv_gm_b0002
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar001_m_conv_gm_b0002-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selMinusM_K20_ce5_tgt70
export ORIGINAL_COMMAND="category=component attack=gradmatch budget=0.002 V=ConvNetBN S=ConvNetBN K=20 component=minus-m base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
