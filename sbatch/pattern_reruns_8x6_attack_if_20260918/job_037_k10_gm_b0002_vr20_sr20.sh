...
#SBATCH --job-name=ar037_k10_gm_b0002_vr20_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar037_k10_gm_b0002_vr20_sr20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_K10_ce5_tgt14
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.002 V=ResNet20BN S=ResNet20BN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
