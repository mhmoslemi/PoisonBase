...
#SBATCH --job-name=ar004_m_r20_gm_b0005
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar004_m_r20_gm_b0005-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selMinusM_K20_ce5_tgt14
export ORIGINAL_COMMAND="category=component attack=gradmatch budget=0.005 V=ResNet20BN S=ResNet20BN K=20 component=minus-m base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
