...
#SBATCH --job-name=ar029_k30_bp_b0005_vvgg_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar029_k30_bp_b0005_vvgg_sconv-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_fc_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selarchConvNetBN_K30_ce5_tgt3
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.005 V=VGG13BN S=ConvNetBN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
