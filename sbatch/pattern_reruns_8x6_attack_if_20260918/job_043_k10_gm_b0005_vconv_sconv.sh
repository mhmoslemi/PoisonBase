...
#SBATCH --job-name=ar043_k10_gm_b0005_vconv_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar043_k10_gm_b0005_vconv_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.005 V=ConvNetBN S=ConvNetBN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
