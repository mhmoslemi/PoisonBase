...
#SBATCH --job-name=ar055_k10_sapa_b0002_vconv_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar055_k10_sapa_b0002_vconv_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.002 V=ConvNetBN S=ConvNetBN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
