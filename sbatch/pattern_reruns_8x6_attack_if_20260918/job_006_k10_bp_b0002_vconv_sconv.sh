...
#SBATCH --job-name=ar006_k10_bp_b0002_vconv_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar006_k10_bp_b0002_vconv_sconv-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_K10_ce5_tgt50
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.002 V=ConvNetBN S=ConvNetBN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
