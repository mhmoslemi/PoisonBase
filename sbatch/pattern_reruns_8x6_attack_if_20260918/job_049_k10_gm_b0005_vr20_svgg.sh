...
#SBATCH --job-name=ar049_k10_gm_b0005_vr20_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar049_k10_gm_b0005_vr20_svgg-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_gradmatch_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selarchVGG13BN_K10_ce5_tgt14
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.005 V=ResNet20BN S=VGG13BN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
