...
#SBATCH --job-name=ar026_k3_bp_b0005_vr20_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar026_k3_bp_b0005_vr20_sr20-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.005 V=ResNet20BN S=ResNet20BN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
