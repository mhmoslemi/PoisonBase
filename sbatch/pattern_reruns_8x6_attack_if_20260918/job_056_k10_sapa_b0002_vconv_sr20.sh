...
#SBATCH --job-name=ar056_k10_sapa_b0002_vconv_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar056_k10_sapa_b0002_vconv_sr20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchResNet20BN_K10_worst0.05_ce5_tgt70
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.002 V=ConvNetBN S=ResNet20BN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
