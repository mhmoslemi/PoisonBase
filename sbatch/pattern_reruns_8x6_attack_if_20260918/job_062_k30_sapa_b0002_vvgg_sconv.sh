...
#SBATCH --job-name=ar062_k30_sapa_b0002_vvgg_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar062_k30_sapa_b0002_vvgg_sconv-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_sapa_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchConvNetBN_K30_worst0.05_ce5_tgt50
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.002 V=VGG13BN S=ConvNetBN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
