...
#SBATCH --job-name=ar016_k3_bp_b0002_vvgg_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar016_k3_bp_b0002_vvgg_sconv-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_fc_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchConvNetBN_K3_ce5_tgt3
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.002 V=VGG13BN S=ConvNetBN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
