...
#SBATCH --job-name=ar041_k3_gm_b0002_vvgg_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar041_k3_gm_b0002_vvgg_svgg-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.002 V=VGG13BN S=VGG13BN K=3 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
