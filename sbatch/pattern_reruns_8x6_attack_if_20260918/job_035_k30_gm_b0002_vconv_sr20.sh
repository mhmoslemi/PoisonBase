...
#SBATCH --job-name=ar035_k30_gm_b0002_vconv_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar035_k30_gm_b0002_vconv_sr20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_gradmatch_ours_dog-bird_b0.002_eps8_seed42_lam1_cosine_selarchResNet20BN_K30_ce5_tgt70
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.002 V=ConvNetBN S=ResNet20BN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
