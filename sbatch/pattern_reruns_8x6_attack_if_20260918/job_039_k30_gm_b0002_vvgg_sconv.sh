...
#SBATCH --job-name=ar039_k30_gm_b0002_vvgg_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar039_k30_gm_b0002_vvgg_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.002 V=VGG13BN S=ConvNetBN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
