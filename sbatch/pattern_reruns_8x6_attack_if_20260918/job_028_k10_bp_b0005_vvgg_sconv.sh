...
#SBATCH --job-name=ar028_k10_bp_b0005_vvgg_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar028_k10_bp_b0005_vvgg_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.005 V=VGG13BN S=ConvNetBN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
