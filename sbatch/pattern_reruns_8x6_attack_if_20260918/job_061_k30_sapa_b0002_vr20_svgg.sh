...
#SBATCH --job-name=ar061_k30_sapa_b0002_vr20_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar061_k30_sapa_b0002_vr20_svgg-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.002 V=ResNet20BN S=VGG13BN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
