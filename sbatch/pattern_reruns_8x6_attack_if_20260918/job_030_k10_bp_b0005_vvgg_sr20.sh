...
#SBATCH --job-name=ar030_k10_bp_b0005_vvgg_sr20
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar030_k10_bp_b0005_vvgg_sr20-%j.out
...
export XFULL_RUN_NAME=CIFAR10_VGG13BN_fc_ours_dog-bird_b0.005_eps8_seed42_lam1_cosine_selarchResNet20BN_K10_ce5_tgt3
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.005 V=VGG13BN S=ResNet20BN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
