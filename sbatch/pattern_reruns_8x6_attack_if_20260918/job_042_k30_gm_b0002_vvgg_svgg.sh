...
#SBATCH --job-name=ar042_k30_gm_b0002_vvgg_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar042_k30_gm_b0002_vvgg_svgg-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.002 V=VGG13BN S=VGG13BN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
