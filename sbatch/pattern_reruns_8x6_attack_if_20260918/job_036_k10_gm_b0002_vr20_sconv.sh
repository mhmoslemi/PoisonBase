...
#SBATCH --job-name=ar036_k10_gm_b0002_vr20_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar036_k10_gm_b0002_vr20_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=gradmatch budget=0.002 V=ResNet20BN S=ConvNetBN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
