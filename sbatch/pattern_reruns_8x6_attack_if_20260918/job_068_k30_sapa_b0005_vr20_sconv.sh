...
#SBATCH --job-name=ar068_k30_sapa_b0005_vr20_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar068_k30_sapa_b0005_vr20_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=sapa budget=0.005 V=ResNet20BN S=ConvNetBN K=30 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
