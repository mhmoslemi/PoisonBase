...
#SBATCH --job-name=ar024_k10_bp_b0005_vr20_sconv
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar024_k10_bp_b0005_vr20_sconv-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.005 V=ResNet20BN S=ConvNetBN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
