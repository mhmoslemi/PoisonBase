...
#SBATCH --job-name=ar022_k10_bp_b0005_vconv_svgg
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/ar022_k10_bp_b0005_vconv_svgg-%j.out
...
export ORIGINAL_COMMAND="category=ensemble attack=fc budget=0.005 V=ConvNetBN S=VGG13BN K=10 component=basis base=ours jacobian=off craft_steps=250 targets=8 victims=6 profile=attack_if"
