...
#SBATCH --job-name=vaugpre_03_r08_random
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ResNet20BN ATTACK=gradmatch TARGET_SELECT=14 BUDGETS=0.01 SELECT=random SEL_ALPHA=2 NUM_TARGETS=5 NUM_VICTIMS=1 RECOMPUTE_DELTAS=1 sh sel_dpp.sh'
...
export EXPECTED_RUN_NAME='CIFAR10_ResNet20BN_gradmatch_random_dog-bird_b0.01_eps8_seed42_ce5_tgt14'
