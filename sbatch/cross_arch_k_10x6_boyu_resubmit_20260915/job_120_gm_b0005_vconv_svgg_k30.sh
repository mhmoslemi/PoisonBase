...
#SBATCH --job-name=xb120_gm_b0005_vconv_svgg_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xb120_gm_b0005_vconv_svgg_k30-%j.out

# Boyu replacement for pending Yiwei job 927208 (xk120).
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 A=V=ConvNetBN S=VGG13BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 replacement_for=927208"
