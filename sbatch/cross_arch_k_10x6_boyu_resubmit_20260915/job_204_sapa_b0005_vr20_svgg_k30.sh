...
#SBATCH --job-name=xb204_sapa_b0005_vr20_svgg_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xb204_sapa_b0005_vr20_svgg_k30-%j.out

# Boyu replacement for pending Yiwei job 927292 (xk204).
...
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=ResNet20BN S=VGG13BN K=30 base=ours jacobian=off craft_steps=250 targets=10 victims=6 replacement_for=927292"
