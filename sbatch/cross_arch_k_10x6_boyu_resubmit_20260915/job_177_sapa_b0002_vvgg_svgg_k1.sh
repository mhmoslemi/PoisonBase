...
#SBATCH --job-name=xb177_sapa_b0002_vvgg_svgg_k1
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xb177_sapa_b0002_vvgg_svgg_k1-%j.out

# Boyu replacement for pending Yiwei job 927265 (xk177).
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 A=V=VGG13BN S=VGG13BN K=1 base=ours jacobian=off craft_steps=250 targets=10 victims=6 replacement_for=927265"
