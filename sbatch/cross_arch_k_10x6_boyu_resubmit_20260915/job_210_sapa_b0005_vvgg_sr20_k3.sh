...
#SBATCH --job-name=xb210_sapa_b0005_vvgg_sr20_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xb210_sapa_b0005_vvgg_sr20_k3-%j.out

# Boyu replacement for pending Yiwei job 927298 (xk210).
...
export ORIGINAL_COMMAND="attack=sapa budget=0.005 A=V=VGG13BN S=ResNet20BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 replacement_for=927298"
