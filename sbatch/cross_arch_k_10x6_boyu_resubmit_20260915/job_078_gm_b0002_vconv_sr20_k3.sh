...
#SBATCH --job-name=xb078_gm_b0002_vconv_sr20_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xb078_gm_b0002_vconv_sr20_k3-%j.out

# Boyu replacement for pending Yiwei job 927166 (xk078).
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.002 A=V=ConvNetBN S=ResNet20BN K=3 base=ours jacobian=off craft_steps=250 targets=10 victims=6 replacement_for=927166"
