...
#SBATCH --job-name=defense_047_vgg13_gradmatch_dog_bird_b0_005_epic_dpp_j
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/defense_047_vgg13_gradmatch_dog_bird_b0_005_epic_dpp_j-%j.out

# L40S walltime: estimated 0-02:15:00; includes the 00:45 cushion.
# Grouped source command: USE_JACOBIAN_SCORE=1 JACOBIAN_WEIGHT=1.0 JACOBIAN_BATCH_SIZE=64 CLASS_PAIR="dog-bird" MODEL="VGG13BN" ATTACK="gradmatch" BUDGETS="0.005" SELS="dpp" SEL_ALPHA=2.0 DEFENSES="epic" NUM_TARGETS=5 NUM_VICTIMS=4 sh defense.sh
# This-cell command: USE_JACOBIAN_SCORE=1 JACOBIAN_WEIGHT=1.0 JACOBIAN_BATCH_SIZE=64 CLASS_PAIR="dog-bird" MODEL="VGG13BN" ATTACK="gradmatch" BUDGETS=0.005 SELS=dpp SEL_ALPHA=2.0 DEFENSES="epic" NUM_TARGETS=7 NUM_VICTIMS=5 sh defense.sh
