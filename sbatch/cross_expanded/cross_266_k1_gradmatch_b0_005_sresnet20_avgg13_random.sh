...
#SBATCH --job-name=cross_266_k1_gradmatch_b0_005_sresnet20_avgg13_random
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/cross_266_k1_gradmatch_b0_005_sresnet20_avgg13_random-%j.out
