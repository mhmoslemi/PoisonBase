...
#SBATCH --job-name=cross_123_k20_gradmatch_b0_002_sresnet20_aconvnet_random
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/cross_123_k20_gradmatch_b0_002_sresnet20_aconvnet_random-%j.out
