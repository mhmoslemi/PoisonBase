...
#SBATCH --job-name=cross_311_k20_gradmatch_b0_005_sresnet20_aconvnet_greedy
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/cross_311_k20_gradmatch_b0_005_sresnet20_aconvnet_greedy-%j.out
