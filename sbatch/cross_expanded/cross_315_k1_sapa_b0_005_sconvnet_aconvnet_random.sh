...
#SBATCH --job-name=cross_315_k1_sapa_b0_005_sconvnet_aconvnet_random
...
#SBATCH --output=/home/mmoslem3/scratch/attack_if/sbatch/logs/cross_315_k1_sapa_b0_005_sconvnet_aconvnet_random-%j.out
