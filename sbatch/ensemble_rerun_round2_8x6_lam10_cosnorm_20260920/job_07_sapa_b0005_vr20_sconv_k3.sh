...
#SBATCH --job-name=enr207_sapa_b0005_vr20_sconv_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr207_sapa_b0005_vr20_sconv_k3-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.005 V=ResNet20BN S=ConvNetBN K=3 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
