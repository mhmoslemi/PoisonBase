...
#SBATCH --job-name=enr224_bp_b0005_vr20_svgg_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr224_bp_b0005_vr20_svgg_k30-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 V=ResNet20BN S=VGG13BN K=30 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
