...
#SBATCH --job-name=enr233_gm_b0005_vconv_sconv_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr233_gm_b0005_vconv_sconv_k30-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 V=ConvNetBN S=ConvNetBN K=30 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
