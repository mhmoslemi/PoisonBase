...
#SBATCH --job-name=enr203_sapa_b0005_vconv_sr20_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr203_sapa_b0005_vconv_sr20_k30-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_sapa_ours_dog-bird_b0.005_eps8_seed42_lam10_cosine_norm_selarchResNet20BN_K30_worst0.05_ce5_tgt70
export ORIGINAL_COMMAND="attack=sapa budget=0.005 V=ConvNetBN S=ResNet20BN K=30 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
