...
#SBATCH --job-name=enr217_bp_b0005_vr20_sconv_k3
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr217_bp_b0005_vr20_sconv_k3-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ResNet20BN_fc_ours_dog-bird_b0.005_eps8_seed42_lam10_cosine_norm_selarchConvNetBN_K3_ce5_tgt10
export ORIGINAL_COMMAND="attack=fc budget=0.005 V=ResNet20BN S=ConvNetBN K=3 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
