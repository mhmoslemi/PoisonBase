...
#SBATCH --job-name=enr234_gm_b0005_vconv_sr20_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr234_gm_b0005_vconv_sr20_k20-%j.out
...
export ORIGINAL_COMMAND="attack=gradmatch budget=0.005 V=ConvNetBN S=ResNet20BN K=20 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
