...
#SBATCH --job-name=enr213_bp_b0002_vconv_sr20_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr213_bp_b0002_vconv_sr20_k20-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.002 V=ConvNetBN S=ResNet20BN K=20 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
