...
#SBATCH --job-name=enr219_bp_b0005_vr20_sconv_k20
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr219_bp_b0005_vr20_sconv_k20-%j.out
...
export ORIGINAL_COMMAND="attack=fc budget=0.005 V=ResNet20BN S=ConvNetBN K=20 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
