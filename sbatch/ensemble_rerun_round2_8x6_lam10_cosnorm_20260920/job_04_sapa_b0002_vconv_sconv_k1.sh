...
#SBATCH --job-name=enr204_sapa_b0002_vconv_sconv_k1
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr204_sapa_b0002_vconv_sconv_k1-%j.out
...
export ORIGINAL_COMMAND="attack=sapa budget=0.002 V=ConvNetBN S=ConvNetBN K=1 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
