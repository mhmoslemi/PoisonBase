...
#SBATCH --job-name=enr214_bp_b0002_vconv_sr20_k30
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/enr214_bp_b0002_vconv_sr20_k30-%j.out
...
export XFULL_RUN_NAME=CIFAR10_ConvNetBN_fc_ours_dog-bird_b0.002_eps8_seed42_lam10_cosine_norm_selarchResNet20BN_K30_ce5_tgt50
export ORIGINAL_COMMAND="attack=fc budget=0.002 V=ConvNetBN S=ResNet20BN K=30 base=ours base_dist=cosine_norm lambda_margin=10 jacobian=off craft_steps=250 victim_epochs=50 victim_decay=40 targets=8 victims=6"
