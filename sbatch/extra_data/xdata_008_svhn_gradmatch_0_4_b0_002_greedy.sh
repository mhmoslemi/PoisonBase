...
#SBATCH --job-name=xdata_008_svhn_gradmatch_0_4_b0_002_greedy
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_008_svhn_gradmatch_0_4_b0_002_greedy-%j.out

# One extra-data.tex result cell: SVHN / ConvNetBN / 0-4 /
...
export CLASS_PAIR=0-4
export BUDGET=0.002
export ATTACK=gradmatch
export TARGET_FILE=target_sets/xdata_SVHN_ConvNetBN_0-4.json
