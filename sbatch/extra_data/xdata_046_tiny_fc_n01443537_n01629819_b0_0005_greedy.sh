...
#SBATCH --job-name=xdata_046_tiny_fc_n01443537_n01629819_b0_0005_greedy
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_046_tiny_fc_n01443537_n01629819_b0_0005_greedy-%j.out

# One extra-data.tex result cell: TinyImageNet / ResNet18BN / n01443537-n01629819 /
# budget 0.0005 / fc / Greedy, with Jacobian disabled.
