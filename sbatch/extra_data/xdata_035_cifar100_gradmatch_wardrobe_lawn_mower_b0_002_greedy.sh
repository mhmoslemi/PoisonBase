...
#SBATCH --job-name=xdata_035_cifar100_gradmatch_wardrobe_lawn_mower_b0_002_greedy
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_035_cifar100_gradmatch_wardrobe_lawn_mower_b0_002_greedy-%j.out
...
# L40S estimate 0:45; request includes the 0:45 cushion plus a 0:15 Vulcan buffer.
