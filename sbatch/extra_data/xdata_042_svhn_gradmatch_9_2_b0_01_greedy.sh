...
#SBATCH --job-name=xdata_042_svhn_gradmatch_9_2_b0_01_greedy
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_042_svhn_gradmatch_9_2_b0_01_greedy-%j.out

# One extra-data.tex result cell: SVHN / ConvNetBN / 9-2 /
# budget 0.01 / gradmatch / Greedy, with Jacobian disabled.
# L40S estimate 1:00; request includes the 0:45 cushion plus a 0:15 Vulcan buffer.
