...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_020_svhn_fc_9_2_b0_01_greedy-%j.out

# One extra-data.tex result cell: SVHN / ConvNetBN / 9-2 /
# budget 0.01 / fc / Greedy, with Jacobian disabled.
# L40S estimate 0:25; request adds the required 0:45 cushion.
