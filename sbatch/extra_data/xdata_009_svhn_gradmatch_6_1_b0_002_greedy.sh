...
#SBATCH --job-name=xdata_009_svhn_gradmatch_6_1_b0_002_greedy
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_009_svhn_gradmatch_6_1_b0_002_greedy-%j.out

# One extra-data.tex result cell: SVHN / ConvNetBN / 6-1 /
# budget 0.002 / gradmatch / Greedy, with Jacobian disabled.
# L40S estimate 0:15; request includes the 0:45 cushion plus a 0:15 Vulcan buffer.

export DATASET=SVHN
export MODEL=ConvNetBN
export CLASS_PAIR=6-1
export BUDGET=0.002
export ATTACK=gradmatch
export TARGET_FILE=target_sets/xdata_SVHN_ConvNetBN_6-1.json
