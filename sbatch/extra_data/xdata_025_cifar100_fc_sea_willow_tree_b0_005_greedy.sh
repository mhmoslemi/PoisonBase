...
#SBATCH --job-name=xdata_025_cifar100_fc_sea_willow_tree_b0_005_greedy
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_025_cifar100_fc_sea_willow_tree_b0_005_greedy-%j.out

# One extra-data.tex result cell: CIFAR100 / ResNet18BN / sea-willow_tree /
# budget 0.005 / fc / Greedy, with Jacobian disabled.
