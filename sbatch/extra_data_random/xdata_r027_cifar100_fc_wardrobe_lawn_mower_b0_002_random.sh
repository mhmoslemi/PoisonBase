...
#SBATCH --job-name=xdata_r027_cifar100_fc_wardrobe_lawn_mower_b0_002_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r027_cifar100_fc_wardrobe_lawn_mower_b0_002_random-%j.out

# One extra-data.tex result cell: CIFAR100 / ResNet18BN / wardrobe-lawn_mower /
# budget 0.002 / fc / Random, with Jacobian disabled.
# L40S estimate 2:00 for the expanded protocol; request includes the 0:45 cushion plus a 0:15 Vulcan buffer.

export DATASET=CIFAR100
export MODEL=ResNet18BN
export CLASS_PAIR=wardrobe-lawn_mower
export BUDGET=0.002
export ATTACK=fc
export TARGET_FILE=target_sets/xdata_CIFAR100_ResNet18BN_wardrobe-lawn_mower.json
