...
#SBATCH --job-name=xdata_r025_cifar100_fc_sea_willow_tree_b0_005_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r025_cifar100_fc_sea_willow_tree_b0_005_random-%j.out

# One extra-data.tex result cell: CIFAR100 / ResNet18BN / sea-willow_tree /
# budget 0.005 / fc / Random, with Jacobian disabled.
