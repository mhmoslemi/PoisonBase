...
#SBATCH --job-name=xdata_r026_cifar100_fc_sunflower_cattle_b0_002_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r026_cifar100_fc_sunflower_cattle_b0_002_random-%j.out
...
export CLASS_PAIR=sunflower-cattle
export BUDGET=0.002
export ATTACK=fc
export TARGET_FILE=target_sets/xdata_CIFAR100_ResNet18BN_sunflower-cattle.json
