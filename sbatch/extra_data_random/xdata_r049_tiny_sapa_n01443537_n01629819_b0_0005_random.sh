...
#SBATCH --job-name=xdata_r049_tiny_sapa_n01443537_n01629819_b0_0005_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r049_tiny_sapa_n01443537_n01629819_b0_0005_random-%j.out

# One extra-data.tex result cell: TinyImageNet / ResNet18BN / n01443537-n01629819 /
# budget 0.0005 / sapa / Random, with Jacobian disabled.
