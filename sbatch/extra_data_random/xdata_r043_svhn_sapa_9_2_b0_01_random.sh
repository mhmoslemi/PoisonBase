...
#SBATCH --job-name=xdata_r043_svhn_sapa_9_2_b0_01_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r043_svhn_sapa_9_2_b0_01_random-%j.out

# One extra-data.tex result cell: SVHN / ConvNetBN / 9-2 /
# budget 0.01 / sapa / Random, with Jacobian disabled.
