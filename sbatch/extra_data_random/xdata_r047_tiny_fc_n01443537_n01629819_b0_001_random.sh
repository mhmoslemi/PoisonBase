...
#SBATCH --job-name=xdata_r047_tiny_fc_n01443537_n01629819_b0_001_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r047_tiny_fc_n01443537_n01629819_b0_001_random-%j.out

# One extra-data.tex result cell: TinyImageNet / ResNet18BN / n01443537-n01629819 /
# budget 0.001 / fc / Random, with Jacobian disabled.
