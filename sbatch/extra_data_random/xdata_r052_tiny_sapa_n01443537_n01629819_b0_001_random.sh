...
#SBATCH --job-name=xdata_r052_tiny_sapa_n01443537_n01629819_b0_001_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r052_tiny_sapa_n01443537_n01629819_b0_001_random-%j.out

# One extra-data.tex result cell: TinyImageNet / ResNet18BN / n01443537-n01629819 /
# budget 0.001 / sapa / Random, with Jacobian disabled.
