...
#SBATCH --job-name=xdata_r041_cifar100_sapa_wardrobe_lawn_mower_b0_002_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r041_cifar100_sapa_wardrobe_lawn_mower_b0_002_random-%j.out

# One extra-data.tex result cell: CIFAR100 / ResNet18BN / wardrobe-lawn_mower /
# budget 0.002 / sapa / Random, with Jacobian disabled.
