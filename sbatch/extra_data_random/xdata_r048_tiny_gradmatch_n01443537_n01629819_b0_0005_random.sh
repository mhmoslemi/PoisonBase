...
#SBATCH --job-name=xdata_r048_tiny_gradmatch_n01443537_n01629819_b0_0005_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r048_tiny_gradmatch_n01443537_n01629819_b0_0005_random-%j.out

# One extra-data.tex result cell: TinyImageNet / ResNet18BN / n01443537-n01629819 /
# budget 0.0005 / gradmatch / Random, with Jacobian disabled.
# L40S estimate 14:00 for the expanded protocol; request includes the 0:45 cushion plus a 0:15 Vulcan buffer.
