...
#SBATCH --job-name=xdata_r044_cifar100_gradmatch_sea_willow_tree_b0_005_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r044_cifar100_gradmatch_sea_willow_tree_b0_005_random-%j.out

# One extra-data.tex result cell: CIFAR100 / ResNet18BN / sea-willow_tree /
# budget 0.005 / gradmatch / Random, with Jacobian disabled.
# L40S estimate 7:00 for the expanded protocol; request is capped at 7:00.
