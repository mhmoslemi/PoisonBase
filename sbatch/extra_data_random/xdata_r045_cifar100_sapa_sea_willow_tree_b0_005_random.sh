...
#SBATCH --job-name=xdata_r045_cifar100_sapa_sea_willow_tree_b0_005_random
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/xdata_r045_cifar100_sapa_sea_willow_tree_b0_005_random-%j.out

# One extra-data.tex result cell: CIFAR100 / ResNet18BN / sea-willow_tree /
# budget 0.005 / sapa / Random, with Jacobian disabled.
