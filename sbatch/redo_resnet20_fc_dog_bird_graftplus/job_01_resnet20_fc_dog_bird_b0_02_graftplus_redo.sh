...
#SBATCH --job-name=redo_r20_fc_db_b002_gp_2restart-strong
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/redo_r20_fc_db_b002_gp_2restart-strong-%j.out

# GRAFT+ redo: ResNet20BN / FC / dog-bird / budget 0.02.
