...
#SBATCH --job-name=defextra_a025_001_convnet_bp_b001_epic
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/defextra_a025_001_convnet_bp_b001_epic-%j.out
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ConvNetBN ATTACK=fc TARGET_SELECT=50 BUDGETS=0.01 SELS=dpp SEL_ALPHA=0.25 DEFENSES=epic NUM_TARGETS=5 NUM_VICTIMS=4 sh defense.sh'
