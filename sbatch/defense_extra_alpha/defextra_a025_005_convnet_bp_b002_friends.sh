...
#SBATCH --job-name=defextra_a025_005_convnet_bp_b002_friends
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/defextra_a025_005_convnet_bp_b002_friends-%j.out

# Exactly one defense-extra table cell: alpha=0.25, FRIENDS,
# ConvNetBN / fc / dog-bird / budget 0.02.
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ConvNetBN ATTACK=fc TARGET_SELECT=50 BUDGETS=0.02 SELS=dpp SEL_ALPHA=0.25 DEFENSES=friends NUM_TARGETS=5 NUM_VICTIMS=4 sh defense.sh'
