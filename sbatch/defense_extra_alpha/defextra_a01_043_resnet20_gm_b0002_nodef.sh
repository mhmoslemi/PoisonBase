...
#SBATCH --job-name=defextra_a01_043_resnet20_gm_b0002_nodef
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/defextra_a01_043_resnet20_gm_b0002_nodef-%j.out
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ResNet20BN ATTACK=gradmatch TARGET_SELECT=14 BUDGETS=0.002 SELECT=dpp SEL_ALPHA=0.1 NUM_TARGETS=5 NUM_VICTIMS=1 sh sel_dpp.sh'
