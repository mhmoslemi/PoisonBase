...
#SBATCH --job-name=defextra_a025_013_resnet20_gm_b0002_epic
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/defextra_a025_013_resnet20_gm_b0002_epic-%j.out
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ResNet20BN ATTACK=gradmatch TARGET_SELECT=14 BUDGETS=0.002 SELS=dpp SEL_ALPHA=0.25 DEFENSES=epic NUM_TARGETS=5 NUM_VICTIMS=4 sh defense.sh'
