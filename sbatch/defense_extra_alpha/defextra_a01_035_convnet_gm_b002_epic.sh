...
#SBATCH --job-name=defextra_a01_035_convnet_gm_b002_epic
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/defextra_a01_035_convnet_gm_b002_epic-%j.out
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=ConvNetBN ATTACK=gradmatch TARGET_SELECT=70 BUDGETS=0.02 SELS=dpp SEL_ALPHA=0.1 DEFENSES=epic NUM_TARGETS=5 NUM_VICTIMS=4 sh defense.sh'
