...
#SBATCH --job-name=defextra_a01_060_vgg13_sapa_b0005_friends
...
#SBATCH --output=/home/mmoslem3/scratch/PoisonBase/sbatch/logs/defextra_a01_060_vgg13_sapa_b0005_friends-%j.out

# Exactly one defense-extra table cell: alpha=0.1, FRIENDS,
# VGG13BN / sapa / dog-bird / budget 0.005.
...
export ORIGINAL_COMMAND='USE_JACOBIAN_SCORE=0 CLASS_PAIR=dog-bird MODEL=VGG13BN ATTACK=sapa TARGET_SELECT=50 BUDGETS=0.005 SELS=dpp SEL_ALPHA=0.1 DEFENSES=friends NUM_TARGETS=5 NUM_VICTIMS=4 sh defense.sh'
