#!/usr/bin/env bash
#
# RESUME  CIFAR10_VGG13BN_gradmatch_random_dog-bird_b0.01_eps8_seed42_ce5_tgt50
#         (the run that was interrupted in Bfinal.sh)
#
# Targets: [630, 409, 2270, 9870, 1656, 5022, 9090, 6033, 7940, 9731]
#   done   -> 630 409 2270 9870 1656 5022     (6/10, all 6 victims each)
#   to run -> 9090 6033 7940 9731             (4 targets x 6 victims = 24 trainings)
#   target 9090 was interrupted during/just after crafting; if its delta made it
#   into deltas.pt it is reused, otherwise it is simply re-crafted.
#
