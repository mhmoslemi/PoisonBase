#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 7 of 18.  Estimated ~5.8 h on one GPU.
#
#   VGG13BN    gradmatch frog-airplane b0.02   tgt12   5/10 targets done, 30 trials left
#   VGG13BN    fc        dog-bird      b0.001  tgt3    0/10 targets done, 60 trials left
#
...
for rec in \
  "VGG13BN gradmatch frog-airplane 0.02 12 target_sets/VGG13BN_gradmatch_frog-airplane.json lowmem" \
  "VGG13BN fc dog-bird 0.001 3 target_sets/VGG13BN_fc_dog-bird.json none"
do
    set -- $rec
    MEM=""
