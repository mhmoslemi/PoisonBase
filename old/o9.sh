#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 9 of 18.  Estimated ~5.7 h on one GPU.
#
#   ResNet20BN gradmatch frog-airplane b0.02   tgt10   5/10 targets done, 29 trials left
#   VGG13BN    fc        frog-airplane b0.01   tgt3    0/10 targets done, 60 trials left
#
...
for rec in \
  "ResNet20BN gradmatch frog-airplane 0.02 10 target_sets/ResNet20BN_gradmatch_frog-airplane.json none" \
  "VGG13BN fc frog-airplane 0.01 3 target_sets/VGG13BN_fc_frog-airplane.json none"
do
    set -- $rec
    MEM=""
