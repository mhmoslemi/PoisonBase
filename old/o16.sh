#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 16 of 18.  Estimated ~5.3 h on one GPU.
#
#   ResNet20BN fc        frog-airplane b0.01   tgt2    0/10 targets done, 60 trials left
#   VGG13BN    gradmatch frog-airplane b0.01   tgt12   6/10 targets done, 24 trials left
#   ConvNetBN  fc        frog-airplane b0.01   tgt20   0/10 targets done, 60 trials left
#   ConvNetBN  gradmatch dog-bird      b0.02   tgt70   9/10 targets done, 4 trials left
#
...
for rec in \
  "ResNet20BN fc frog-airplane 0.01 2 target_sets/ResNet20BN_fc_frog-airplane.json none" \
  "VGG13BN gradmatch frog-airplane 0.01 12 target_sets/VGG13BN_gradmatch_frog-airplane.json lowmem" \
  "ConvNetBN fc frog-airplane 0.01 20 target_sets/ConvNetBN_fc_frog-airplane.json none" \
  "ConvNetBN gradmatch dog-bird 0.02 70 target_sets/ConvNetBN_gradmatch_dog-bird.json none"
do
    set -- $rec
    MEM=""
