#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 17 of 18.  Estimated ~5.0 h on one GPU.
#
#   ResNet20BN fc        dog-bird      b0.001  tgt10   0/10 targets done, 60 trials left
#   VGG13BN    gradmatch dog-bird      b0.001  tgt50   0/10 targets done, 60 trials left
#   ConvNetBN  fc        frog-airplane b0.005  tgt20   0/10 targets done, 60 trials left
#
...
for rec in \
  "ResNet20BN fc dog-bird 0.001 10 target_sets/ResNet20BN_fc_dog-bird.json none" \
  "VGG13BN gradmatch dog-bird 0.001 50 target_sets/VGG13BN_gradmatch_dog-bird.json lowmem" \
  "ConvNetBN fc frog-airplane 0.005 20 target_sets/ConvNetBN_fc_frog-airplane.json none"
do
    set -- $rec
    MEM=""
