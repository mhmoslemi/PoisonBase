#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 4 of 18.  Estimated ~10.2 h on one GPU.
#
#   VGG13BN    gradmatch frog-airplane b0.04   tgt12   3/10 targets done, 42 trials left
#
...
for rec in \
  "VGG13BN gradmatch frog-airplane 0.04 12 target_sets/VGG13BN_gradmatch_frog-airplane.json lowmem"
do
    set -- $rec
    MEM=""
