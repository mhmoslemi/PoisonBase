#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 14 of 18.  Estimated ~5.8 h on one GPU.
#
#   ResNet20BN fc        frog-airplane b0.02   tgt2    0/10 targets done, 60 trials left
#   ResNet20BN gradmatch dog-bird      b0.01   tgt14   6/10 targets done, 23 trials left
#   VGG13BN    fc        frog-airplane b0.001  tgt3    0/10 targets done, 60 trials left
#
...
for rec in \
  "ResNet20BN fc frog-airplane 0.02 2 target_sets/ResNet20BN_fc_frog-airplane.json none" \
  "ResNet20BN gradmatch dog-bird 0.01 14 target_sets/ResNet20BN_gradmatch_dog-bird.json none" \
  "VGG13BN fc frog-airplane 0.001 3 target_sets/VGG13BN_fc_frog-airplane.json none"
do
    set -- $rec
    MEM=""
