#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 10 of 18.  Estimated ~5.2 h on one GPU.
#
#   ConvNetBN  gradmatch frog-airplane b0.04   tgt35   6/10 targets done, 24 trials left
#   VGG13BN    fc        frog-airplane b0.02   tgt3    0/10 targets done, 60 trials left
#   VGG13BN    gradmatch dog-bird      b0.002  tgt50   7/10 targets done, 18 trials left
#
...
for rec in \
  "ConvNetBN gradmatch frog-airplane 0.04 35 target_sets/ConvNetBN_gradmatch_frog-airplane.json none" \
  "VGG13BN fc frog-airplane 0.02 3 target_sets/VGG13BN_fc_frog-airplane.json none" \
  "VGG13BN gradmatch dog-bird 0.002 50 target_sets/VGG13BN_gradmatch_dog-bird.json lowmem"
do
    set -- $rec
    MEM=""
