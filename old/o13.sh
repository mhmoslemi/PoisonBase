#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 13 of 18.  Estimated ~5.0 h on one GPU.
#
#   ResNet20BN fc        dog-bird      b0.02   tgt10   0/10 targets done, 60 trials left
#   ResNet20BN gradmatch frog-airplane b0.01   tgt10   6/10 targets done, 24 trials left
#   ConvNetBN  fc        frog-airplane b0.04   tgt20   0/10 targets done, 60 trials left
#
...
for rec in \
  "ResNet20BN fc dog-bird 0.02 10 target_sets/ResNet20BN_fc_dog-bird.json none" \
  "ResNet20BN gradmatch frog-airplane 0.01 10 target_sets/ResNet20BN_gradmatch_frog-airplane.json none" \
  "ConvNetBN fc frog-airplane 0.04 20 target_sets/ConvNetBN_fc_frog-airplane.json none"
do
    set -- $rec
    MEM=""
