#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 3 of 18.  Estimated ~10.2 h on one GPU.
#
#   VGG13BN    gradmatch dog-bird      b0.04   tgt50   3/10 targets done, 42 trials left
#
...
for rec in \
  "VGG13BN gradmatch dog-bird 0.04 50 target_sets/VGG13BN_gradmatch_dog-bird.json lowmem"
do
    set -- $rec
    MEM=""
