#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 1 of 18.  Estimated ~10.4 h on one GPU.
#
#   ResNet20BN gradmatch dog-bird      b0.04   tgt14   3/10 targets done, 42 trials left
#
...
for rec in \
  "ResNet20BN gradmatch dog-bird 0.04 14 target_sets/ResNet20BN_gradmatch_dog-bird.json none"
do
    set -- $rec
    MEM=""
