#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 12 of 18.  Estimated ~5.2 h on one GPU.
#
#   ResNet20BN gradmatch frog-airplane b0.001  tgt10   0/10 targets done, 60 trials left
#   VGG13BN    fc        dog-bird      b0.02   tgt3    0/10 targets done, 60 trials left
#   ConvNetBN  fc        frog-airplane b0.001  tgt20   0/10 targets done, 60 trials left
#
...
for rec in \
  "ResNet20BN gradmatch frog-airplane 0.001 10 target_sets/ResNet20BN_gradmatch_frog-airplane.json none" \
  "VGG13BN fc dog-bird 0.02 3 target_sets/VGG13BN_fc_dog-bird.json none" \
  "ConvNetBN fc frog-airplane 0.001 20 target_sets/ConvNetBN_fc_frog-airplane.json none"
do
    set -- $rec
    MEM=""
