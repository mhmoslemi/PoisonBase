#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 6 of 18.  Estimated ~5.8 h on one GPU.
#
#   VGG13BN    gradmatch dog-bird      b0.02   tgt50   5/10 targets done, 30 trials left
#   ResNet20BN gradmatch dog-bird      b0.002  tgt14   4/10 targets done, 36 trials left
#
...
for rec in \
  "VGG13BN gradmatch dog-bird 0.02 50 target_sets/VGG13BN_gradmatch_dog-bird.json lowmem" \
  "ResNet20BN gradmatch dog-bird 0.002 14 target_sets/ResNet20BN_gradmatch_dog-bird.json none"
do
    set -- $rec
    MEM=""
