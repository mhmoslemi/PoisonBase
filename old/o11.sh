#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 11 of 18.  Estimated ~5.2 h on one GPU.
#
#   ResNet20BN gradmatch dog-bird      b0.001  tgt14   0/10 targets done, 60 trials left
#   ResNet20BN gradmatch frog-airplane b0.002  tgt10   3/10 targets done, 37 trials left
#   VGG13BN    gradmatch frog-airplane b0.002  tgt12   7/10 targets done, 17 trials left
#
...
for rec in \
  "ResNet20BN gradmatch dog-bird 0.001 14 target_sets/ResNet20BN_gradmatch_dog-bird.json none" \
  "ResNet20BN gradmatch frog-airplane 0.002 10 target_sets/ResNet20BN_gradmatch_frog-airplane.json none" \
  "VGG13BN gradmatch frog-airplane 0.002 12 target_sets/VGG13BN_gradmatch_frog-airplane.json lowmem"
do
    set -- $rec
    MEM=""
