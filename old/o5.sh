#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 5 of 18.  Estimated ~6.8 h on one GPU.
#
#   ConvNetBN  gradmatch dog-bird      b0.04   tgt70   0/10 targets done, 60 trials left
#
...
for rec in \
  "ConvNetBN gradmatch dog-bird 0.04 70 target_sets/ConvNetBN_gradmatch_dog-bird.json none"
do
    set -- $rec
    MEM=""
