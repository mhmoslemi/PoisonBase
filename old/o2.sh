#!/usr/bin/env bash
#
# base=ours (cosine) sweep -- shard 2 of 18.  Estimated ~10.4 h on one GPU.
#
#   ResNet20BN gradmatch frog-airplane b0.04   tgt10   3/10 targets done, 42 trials left
#
...
for rec in \
  "ResNet20BN gradmatch frog-airplane 0.04 10 target_sets/ResNet20BN_gradmatch_frog-airplane.json none"
do
    set -- $rec
    MEM=""
